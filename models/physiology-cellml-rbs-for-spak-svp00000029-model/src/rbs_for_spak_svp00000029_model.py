...
"""Auto-generated CellML BioModule wrapper for RBS for spaK.

Source: physiome:SVP_00000029
Original: https://models.physiomeproject.org/workspace/SVP_00000029
"""
...
class CellmlRbsForSpak(biosim.BioModule):
    """BioModule wrapper for CellML model: RBS for spaK."""

    def __init__(self, model_path: str = "data/Bugbuster_RBS_spaK.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RbsForSpakSvp00000029Model = CellmlRbsForSpak
