...
"""Auto-generated CellML BioModule wrapper for Formation of PYO.

Source: physiome:SVP_00000019
Original: https://models.physiomeproject.org/workspace/SVP_00000019
"""
...
class CellmlFormationOfPyo(biosim.BioModule):
    """BioModule wrapper for CellML model: Formation of PYO."""

    def __init__(self, model_path: str = "data/Bioenvironment_RxR1P1MM_PYOFormation.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FormationOfPyoSvp00000019Model = CellmlFormationOfPyo
