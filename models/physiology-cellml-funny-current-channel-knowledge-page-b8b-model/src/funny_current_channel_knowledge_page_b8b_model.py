...
"""Auto-generated CellML BioModule wrapper for Funny current channel knowledge page.

Source: physiome:b8b
Original: https://models.physiomeproject.org/workspace/b8b
"""
...
class CellmlFunnyCurrentChannelKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: Funny current channel knowledge page."""

    def __init__(self, model_path: str = "data/BG_funny.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FunnyCurrentChannelKnowledgePageB8bModel = CellmlFunnyCurrentChannelKnowledgePage
