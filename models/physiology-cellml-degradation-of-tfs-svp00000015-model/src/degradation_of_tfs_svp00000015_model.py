...
"""Auto-generated CellML BioModule wrapper for Degradation of TFS.

Source: physiome:SVP_00000015
Original: https://models.physiomeproject.org/workspace/SVP_00000015
"""
...
class CellmlDegradationOfTfs(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of TFS."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_TFS.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfTfsSvp00000015Model = CellmlDegradationOfTfs
