...
"""Auto-generated CellML BioModule wrapper for A model of intracellular pH control.

Source: physiome:4a3
Original: https://models.physiomeproject.org/workspace/4a3
"""
...
class CellmlAModelOfIntracellularPhControl(biosim.BioModule):
    """BioModule wrapper for CellML model: A model of intracellular pH control."""

    def __init__(self, model_path: str = "data/model.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AModelOfIntracellularPhControl4a3Model = CellmlAModelOfIntracellularPhControl
