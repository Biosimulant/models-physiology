...
"""Auto-generated CellML BioModule wrapper for EAAT2 - The Physics of Physiology.

Source: physiome:c85
Original: https://models.physiomeproject.org/workspace/c85
"""
...
class CellmlEaat2ThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: EAAT2 - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_EAAT2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Eaat2ThePhysicsOfPhysiologyC85Model = CellmlEaat2ThePhysicsOfPhysiology
