...
"""Auto-generated CellML BioModule wrapper for Noble, Noble, 2001.

Source: physiome:noble_noble_2001
Original: https://models.physiomeproject.org/workspace/noble_noble_2001
"""
...
class CellmlNobleNoble2001(biosim.BioModule):
    """BioModule wrapper for CellML model: Noble, Noble, 2001."""

    def __init__(self, model_path: str = "data/noble_noble_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NobleNoble2001Noblenoble2001Model = CellmlNobleNoble2001
