...
**Source**: [physiome](https://models.physiomeproject.org/workspace/guyton_2008)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-guyton-full-cardiovascular-circulation-model-guyton2008-model
    alias: model
```
