...
"""Auto-generated CellML BioModule wrapper for Principled Model Base.

Source: physiome:2c3
Original: https://models.physiomeproject.org/workspace/2c3
"""
...
class CellmlPrincipledModelBase(biosim.BioModule):
    """BioModule wrapper for CellML model: Principled Model Base."""

    def __init__(self, model_path: str = "data/Template_Bernoulli_dimensionless.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PrincipledModelBase2c3Model = CellmlPrincipledModelBase
