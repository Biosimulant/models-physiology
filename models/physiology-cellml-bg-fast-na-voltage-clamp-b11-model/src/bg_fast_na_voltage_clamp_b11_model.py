...
"""Auto-generated CellML BioModule wrapper for BG_fast_Na_voltage_clamp.

Source: physiome:b11
Original: https://models.physiomeproject.org/workspace/b11
"""
...
class CellmlBgFastNaVoltageClamp(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_fast_Na_voltage_clamp."""

    def __init__(self, model_path: str = "data/BG_fast_Na_voltage_clamp.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgFastNaVoltageClampB11Model = CellmlBgFastNaVoltageClamp
