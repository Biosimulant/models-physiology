...
"""Auto-generated CellML BioModule wrapper for Neurovascular Coupling.

Source: physiome:5c8
Original: https://models.physiomeproject.org/workspace/5c8
"""
...
class CellmlNeurovascularCoupling(biosim.BioModule):
    """BioModule wrapper for CellML model: Neurovascular Coupling."""

    def __init__(self, model_path: str = "data/Astrocyte.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NeurovascularCoupling5c8Model = CellmlNeurovascularCoupling
