...
"""Auto-generated CellML BioModule wrapper for Karagiannis, Popel, 2004.

Source: physiome:karagiannis_popel_2004
Original: https://models.physiomeproject.org/workspace/karagiannis_popel_2004
"""
...
class CellmlKaragiannisPopel2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Karagiannis, Popel, 2004."""

    def __init__(self, model_path: str = "data/karagiannis_popel_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KaragiannisPopel2004Karagiannispopel2004Model = CellmlKaragiannisPopel2004
