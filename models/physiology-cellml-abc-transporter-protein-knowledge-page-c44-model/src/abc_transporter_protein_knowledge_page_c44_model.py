...
"""Auto-generated CellML BioModule wrapper for ABC transporter protein knowledge page.

Source: physiome:c44
Original: https://models.physiomeproject.org/workspace/c44
"""
...
class CellmlAbcTransporterProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: ABC transporter protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_ABC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AbcTransporterProteinKnowledgePageC44Model = CellmlAbcTransporterProteinKnowledgePage
