...
"""Auto-generated CellML BioModule wrapper for BG_ns_Ca.

Source: physiome:83b
Original: https://models.physiomeproject.org/workspace/83b
"""
...
class CellmlBgNsCa(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_ns_Ca."""

    def __init__(self, model_path: str = "data/BG_ns.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
