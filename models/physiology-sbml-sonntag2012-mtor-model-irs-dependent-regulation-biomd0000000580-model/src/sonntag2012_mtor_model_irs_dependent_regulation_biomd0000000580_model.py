...
"""Auto-generated SBML BioModule wrapper for Sonntag2012 - mTOR model - IRS dependent regulation of AMPK by insulin.

Source: biomodels_ebi:BIOMD0000000580
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000580
"""
...
class SbmlSonntag2012MtorModelIrsDependentRegulationOfAmpkBy(biosim.BioModule):
    """BioModule wrapper for SBML model: Sonntag2012 - mTOR model - IRS dependent regulation of AMPK by insulin."""

    def __init__(self, model_path: str = "data/BIOMD0000000580.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sonntag2012MtorModelIrsDependentRegulationBiomd0000000580Model = SbmlSonntag2012MtorModelIrsDependentRegulationOfAmpkBy
