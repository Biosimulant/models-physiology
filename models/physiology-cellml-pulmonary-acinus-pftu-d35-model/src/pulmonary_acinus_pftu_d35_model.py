...
"""Auto-generated CellML BioModule wrapper for Pulmonary Acinus pFTU.

Source: physiome:d35
Original: https://models.physiomeproject.org/workspace/d35
"""
...
class CellmlPulmonaryAcinusPftu(biosim.BioModule):
    """BioModule wrapper for CellML model: Pulmonary Acinus pFTU."""

    def __init__(self, model_path: str = "data/AthanasiadesPHSinSIwithGasET.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PulmonaryAcinusPftuD35Model = CellmlPulmonaryAcinusPftu
