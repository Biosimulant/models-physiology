...
"""Auto-generated CellML BioModule wrapper for Na+/HCO3- Cotransporter.

Source: physiome:295
Original: https://models.physiomeproject.org/workspace/295
"""
...
class CellmlNaHco3Cotransporter(biosim.BioModule):
    """BioModule wrapper for CellML model: Na+/HCO3- Cotransporter."""

    def __init__(self, model_path: str = "data/NBC_test.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NaHco3Cotransporter295Model = CellmlNaHco3Cotransporter
