...
"""Auto-generated CellML BioModule wrapper for units_and_constants_for_BG.

Source: physiome:706
Original: https://models.physiomeproject.org/workspace/706
"""
...
class CellmlUnitsAndConstantsForBg(biosim.BioModule):
    """BioModule wrapper for CellML model: units_and_constants_for_BG."""

    def __init__(self, model_path: str = "data/constants_BG.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UnitsAndConstantsForBg706Model = CellmlUnitsAndConstantsForBg
