...
"""Auto-generated CellML BioModule wrapper for Chang, Fujita, B, 1999.

Source: physiome:chang_fujita_b_1999
Original: https://models.physiomeproject.org/workspace/chang_fujita_b_1999
"""
...
class CellmlChangFujitaB19992(biosim.BioModule):
    """BioModule wrapper for CellML model: Chang, Fujita, B, 1999."""

    def __init__(self, model_path: str = "data/chang_fujita_b_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChangFujitaB1999Changfujitab1999Model = CellmlChangFujitaB19992
