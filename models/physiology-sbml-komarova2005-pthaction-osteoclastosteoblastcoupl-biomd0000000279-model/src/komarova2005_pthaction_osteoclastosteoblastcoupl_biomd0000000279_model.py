...
"""Auto-generated SBML BioModule wrapper for Komarova2005_PTHaction_OsteoclastOsteoblastCoupling.

Source: biomodels_ebi:BIOMD0000000279
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000279
"""
...
class SbmlKomarova2005PthactionOsteoclastosteoblastcoupling(biosim.BioModule):
    """BioModule wrapper for SBML model: Komarova2005_PTHaction_OsteoclastOsteoblastCoupling."""

    def __init__(self, model_path: str = "data/BIOMD0000000279.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Komarova2005PthactionOsteoclastosteoblastcouplBiomd0000000279Model = SbmlKomarova2005PthactionOsteoclastosteoblastcoupling
