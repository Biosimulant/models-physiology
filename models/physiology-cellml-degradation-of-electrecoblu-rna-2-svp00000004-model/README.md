...
**Source**: [physiome](https://models.physiomeproject.org/workspace/SVP_00000004)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-degradation-of-electrecoblu-rna-2-svp00000004-model/model.yaml
```
