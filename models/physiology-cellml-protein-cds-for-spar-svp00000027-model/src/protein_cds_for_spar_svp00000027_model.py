...
"""Auto-generated CellML BioModule wrapper for Protein CDS for spaR.

Source: physiome:SVP_00000027
Original: https://models.physiomeproject.org/workspace/SVP_00000027
"""
...
class CellmlProteinCdsForSpar(biosim.BioModule):
    """BioModule wrapper for CellML model: Protein CDS for spaR."""

    def __init__(self, model_path: str = "data/Bugbuster_ProteinCDS_spaR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ProteinCdsForSparSvp00000027Model = CellmlProteinCdsForSpar
