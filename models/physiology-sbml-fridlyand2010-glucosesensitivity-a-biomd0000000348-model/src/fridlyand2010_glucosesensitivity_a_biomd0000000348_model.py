...
"""Auto-generated SBML BioModule wrapper for Fridlyand2010_GlucoseSensitivity_A.

Source: biomodels_ebi:BIOMD0000000348
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000348
"""
...
class SbmlFridlyand2010GlucosesensitivityA(biosim.BioModule):
    """BioModule wrapper for SBML model: Fridlyand2010_GlucoseSensitivity_A."""

    def __init__(self, model_path: str = "data/BIOMD0000000348.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fridlyand2010GlucosesensitivityABiomd0000000348Model = SbmlFridlyand2010GlucosesensitivityA
