...
"""Auto-generated CellML BioModule wrapper for Ni et al. 2017 Human atrial model.

Source: physiome:5b0
Original: https://models.physiomeproject.org/workspace/5b0
"""
...
class CellmlNiEtAl2017HumanAtrialModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Ni et al. 2017 Human atrial model."""

    def __init__(self, model_path: str = "data/ni_2017.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NiEtAl2017HumanAtrialModel5b0Model = CellmlNiEtAl2017HumanAtrialModel
