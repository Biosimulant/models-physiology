...
"""Auto-generated CellML BioModule wrapper for Kernik et al. 2019.

Source: physiome:6ed
Original: https://models.physiomeproject.org/workspace/6ed
"""
...
class CellmlKernikEtAl2019(biosim.BioModule):
    """BioModule wrapper for CellML model: Kernik et al. 2019."""

    def __init__(self, model_path: str = "data/kernik-2019.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KernikEtAl20196edModel = CellmlKernikEtAl2019
