...
"""Auto-generated CellML BioModule wrapper for Kirschner, Webb, 1996.

Source: physiome:kirschner_webb_1996
Original: https://models.physiomeproject.org/workspace/kirschner_webb_1996
"""
...
class CellmlKirschnerWebb1996(biosim.BioModule):
    """BioModule wrapper for CellML model: Kirschner, Webb, 1996."""

    def __init__(self, model_path: str = "data/kirschner_webb_1996.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KirschnerWebb1996Kirschnerwebb1996Model = CellmlKirschnerWebb1996
