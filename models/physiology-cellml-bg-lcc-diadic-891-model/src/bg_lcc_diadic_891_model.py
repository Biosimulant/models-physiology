...
"""Auto-generated CellML BioModule wrapper for BG_LCC_diadic.

Source: physiome:891
Original: https://models.physiomeproject.org/workspace/891
"""
...
class CellmlBgLccDiadic(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_LCC_diadic."""

    def __init__(self, model_path: str = "data/BG_LCC_diadic.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgLccDiadic891Model = CellmlBgLccDiadic
