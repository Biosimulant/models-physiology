...
**Source**: [physiome](https://models.physiomeproject.org/workspace/546)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-an-integrative-dynamic-model-of-brain-energy-met-546-model
    alias: model
```
