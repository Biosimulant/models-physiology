...
"""Auto-generated CellML BioModule wrapper for Novak, Tyson, 2004.

Source: physiome:novak_tyson_2004
Original: https://models.physiomeproject.org/workspace/novak_tyson_2004
"""
...
class CellmlNovakTyson2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Novak, Tyson, 2004."""

    def __init__(self, model_path: str = "data/novak_tyson_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NovakTyson2004Novaktyson2004Model = CellmlNovakTyson2004
