...
"""Auto-generated CellML BioModule wrapper for Degradation of TF.

Source: physiome:SVP_00000014
Original: https://models.physiomeproject.org/workspace/SVP_00000014
"""
...
class CellmlDegradationOfTf(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of TF."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_TF.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfTfSvp00000014Model = CellmlDegradationOfTf
