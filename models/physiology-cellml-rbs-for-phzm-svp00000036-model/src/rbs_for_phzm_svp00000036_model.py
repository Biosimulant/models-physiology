...
"""Auto-generated CellML BioModule wrapper for RBS for PhzM.

Source: physiome:SVP_00000036
Original: https://models.physiomeproject.org/workspace/SVP_00000036
"""
...
class CellmlRbsForPhzm(biosim.BioModule):
    """BioModule wrapper for CellML model: RBS for PhzM."""

    def __init__(self, model_path: str = "data/ElectrEcoBluDevice2_RBS_PhzM.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RbsForPhzmSvp00000036Model = CellmlRbsForPhzm
