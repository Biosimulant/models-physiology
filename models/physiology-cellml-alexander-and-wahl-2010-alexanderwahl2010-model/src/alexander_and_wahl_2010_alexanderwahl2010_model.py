...
"""Auto-generated CellML BioModule wrapper for Alexander and Wahl 2010.

Source: physiome:alexander_wahl_2010
Original: https://models.physiomeproject.org/workspace/alexander_wahl_2010
"""
...
class CellmlAlexanderAndWahl20102(biosim.BioModule):
    """BioModule wrapper for CellML model: Alexander and Wahl 2010."""

    def __init__(self, model_path: str = "data/alexander_2010.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AlexanderAndWahl2010Alexanderwahl2010Model = CellmlAlexanderAndWahl20102
