...
"""Auto-generated CellML BioModule wrapper for Kernik_physiome.

Source: physiome:c17
Original: https://models.physiomeproject.org/workspace/c17
"""
...
class CellmlKernikPhysiome(biosim.BioModule):
    """BioModule wrapper for CellML model: Kernik_physiome."""

    def __init__(self, model_path: str = "data/Channels.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KernikPhysiomeC17Model = CellmlKernikPhysiome
