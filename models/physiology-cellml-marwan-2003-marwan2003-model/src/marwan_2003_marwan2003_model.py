...
"""Auto-generated CellML BioModule wrapper for Marwan, 2003.

Source: physiome:marwan_2003
Original: https://models.physiomeproject.org/workspace/marwan_2003
"""
...
class CellmlMarwan2003(biosim.BioModule):
    """BioModule wrapper for CellML model: Marwan, 2003."""

    def __init__(self, model_path: str = "data/marwan_2003.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Marwan2003Marwan2003Model = CellmlMarwan2003
