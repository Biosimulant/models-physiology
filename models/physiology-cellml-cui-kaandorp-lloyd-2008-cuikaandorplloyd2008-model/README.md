...
**Source**: [physiome](https://models.physiomeproject.org/workspace/cui_kaandorp_lloyd_2008)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-cui-kaandorp-lloyd-2008-cuikaandorplloyd2008-model
    alias: model
```
