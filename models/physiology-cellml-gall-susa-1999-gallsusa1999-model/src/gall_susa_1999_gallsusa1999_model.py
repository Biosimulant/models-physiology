...
"""Auto-generated CellML BioModule wrapper for Gall, Susa, 1999.

Source: physiome:gall_susa_1999
Original: https://models.physiomeproject.org/workspace/gall_susa_1999
"""
...
class CellmlGallSusa1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Gall, Susa, 1999."""

    def __init__(self, model_path: str = "data/gall_susa_1999_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GallSusa1999Gallsusa1999Model = CellmlGallSusa1999
