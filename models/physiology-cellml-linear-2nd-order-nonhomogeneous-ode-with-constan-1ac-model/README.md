...
**Source**: [physiome](https://models.physiomeproject.org/workspace/1ac)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-linear-2nd-order-nonhomogeneous-ode-with-constan-1ac-model
    alias: model
```
