...
"""Auto-generated CellML BioModule wrapper for Devries, Sherman, 2000.

Source: physiome:devries_sherman_2000
Original: https://models.physiomeproject.org/workspace/devries_sherman_2000
"""
...
class CellmlDevriesSherman2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Devries, Sherman, 2000."""

    def __init__(self, model_path: str = "data/devries_sherman_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DevriesSherman2000Devriessherman2000Model = CellmlDevriesSherman2000
