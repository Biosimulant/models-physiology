...
"""Auto-generated CellML BioModule wrapper for AE1-BG.

Source: physiome:6b9
Original: https://models.physiomeproject.org/workspace/6b9
"""
...
class CellmlAe1Bg(biosim.BioModule):
    """BioModule wrapper for CellML model: AE1-BG."""

    def __init__(self, model_path: str = "data/AE1-BG.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
