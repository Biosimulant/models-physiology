...
"""Auto-generated SBML BioModule wrapper for Jiang2007 - GSIS system, Pancreatic Beta Cells.

Source: biomodels_ebi:BIOMD0000000239
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000239
"""
...
class SbmlJiang2007GsisSystemPancreaticBetaCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Jiang2007 - GSIS system, Pancreatic Beta Cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000239.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jiang2007GsisSystemPancreaticBetaCellsBiomd0000000239Model = SbmlJiang2007GsisSystemPancreaticBetaCells
