...
"""Auto-generated CellML BioModule wrapper for BG_AE.

Source: physiome:882
Original: https://models.physiomeproject.org/workspace/882
"""
...
class CellmlBgAe(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_AE."""

    def __init__(self, model_path: str = "data/BG_AE.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
