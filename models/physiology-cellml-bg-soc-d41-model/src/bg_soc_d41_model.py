...
"""Auto-generated CellML BioModule wrapper for BG_SOC.

Source: physiome:d41
Original: https://models.physiomeproject.org/workspace/d41
"""
...
class CellmlBgSoc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_SOC."""

    def __init__(self, model_path: str = "data/BG_SOC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
