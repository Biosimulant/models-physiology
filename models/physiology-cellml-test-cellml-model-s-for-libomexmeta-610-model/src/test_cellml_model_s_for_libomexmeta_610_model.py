...
"""Auto-generated CellML BioModule wrapper for Test cellml model(s) for LibOmexMeta.

Source: physiome:610
Original: https://models.physiomeproject.org/workspace/610
"""
...
class CellmlTestCellmlModelSForLibomexmeta(biosim.BioModule):
    """BioModule wrapper for CellML model: Test cellml model(s) for LibOmexMeta."""

    def __init__(self, model_path: str = "data/nernst_eg.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TestCellmlModelSForLibomexmeta610Model = CellmlTestCellmlModelSForLibomexmeta
