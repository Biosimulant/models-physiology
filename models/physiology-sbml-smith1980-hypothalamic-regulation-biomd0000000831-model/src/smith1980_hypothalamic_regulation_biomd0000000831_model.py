...
"""Auto-generated SBML BioModule wrapper for Smith1980 - Hypothalamic Regulation.

Source: biomodels_ebi:BIOMD0000000831
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000831
"""
...
class SbmlSmith1980HypothalamicRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith1980 - Hypothalamic Regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000831.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith1980HypothalamicRegulationBiomd0000000831Model = SbmlSmith1980HypothalamicRegulation
