...
"""Auto-generated CellML BioModule wrapper for Wodarz, 2003.

Source: physiome:wodarz_2003
Original: https://models.physiomeproject.org/workspace/wodarz_2003
"""
...
class CellmlWodarz2003(biosim.BioModule):
    """BioModule wrapper for CellML model: Wodarz, 2003."""

    def __init__(self, model_path: str = "data/wodarz_2003.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2003Wodarz2003Model = CellmlWodarz2003
