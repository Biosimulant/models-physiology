...
"""Auto-generated CellML BioModule wrapper for CaB protein knowledge page.

Source: physiome:bdd
Original: https://models.physiomeproject.org/workspace/bdd
"""
...
class CellmlCabProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: CaB protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_CaB.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CabProteinKnowledgePageBddModel = CellmlCabProteinKnowledgePage
