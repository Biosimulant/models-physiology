...
"""Auto-generated CellML BioModule wrapper for Na channel knowledge page.

Source: physiome:b7e
Original: https://models.physiomeproject.org/workspace/b7e
"""
...
class CellmlNaChannelKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: Na channel knowledge page."""

    def __init__(self, model_path: str = "data/BG_Na.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NaChannelKnowledgePageB7eModel = CellmlNaChannelKnowledgePage
