...
"""Auto-generated CellML BioModule wrapper for BG_GPCR_M2_reduced.

Source: physiome:7dd
Original: https://models.physiomeproject.org/workspace/7dd
"""
...
class CellmlBgGpcrM2Reduced(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_GPCR_M2_reduced."""

    def __init__(self, model_path: str = "data/BG_GPCR_M2_reduced.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgGpcrM2Reduced7ddModel = CellmlBgGpcrM2Reduced
