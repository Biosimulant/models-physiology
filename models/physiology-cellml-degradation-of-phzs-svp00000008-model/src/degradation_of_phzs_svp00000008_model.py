...
"""Auto-generated CellML BioModule wrapper for Degradation of PhzS.

Source: physiome:SVP_00000008
Original: https://models.physiomeproject.org/workspace/SVP_00000008
"""
...
class CellmlDegradationOfPhzs(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of PhzS."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_PhzS.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfPhzsSvp00000008Model = CellmlDegradationOfPhzs
