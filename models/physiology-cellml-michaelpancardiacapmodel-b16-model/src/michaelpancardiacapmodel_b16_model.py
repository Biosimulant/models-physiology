...
"""Auto-generated CellML BioModule wrapper for MichaelPanCardiacAPModel.

Source: physiome:b16
Original: https://models.physiomeproject.org/workspace/b16
"""
...
class CellmlMichaelpancardiacapmodel(biosim.BioModule):
    """BioModule wrapper for CellML model: MichaelPanCardiacAPModel."""

    def __init__(self, model_path: str = "data/MichaelPanCardiacAPModel.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MichaelpancardiacapmodelB16Model = CellmlMichaelpancardiacapmodel
