...
"""Auto-generated CellML BioModule wrapper for Degradation of PYO.

Source: physiome:SVP_00000009
Original: https://models.physiomeproject.org/workspace/SVP_00000009
"""
...
class CellmlDegradationOfPyo(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of PYO."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_PYO.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfPyoSvp00000009Model = CellmlDegradationOfPyo
