...
"""Auto-generated CellML BioModule wrapper for Notch signaling pathway.

Source: physiome:1cd
Original: https://models.physiomeproject.org/workspace/1cd
"""
...
class CellmlNotchSignalingPathway(biosim.BioModule):
    """BioModule wrapper for CellML model: Notch signaling pathway."""

    def __init__(self, model_path: str = "data/Notch_1_Wang.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NotchSignalingPathway1cdModel = CellmlNotchSignalingPathway
