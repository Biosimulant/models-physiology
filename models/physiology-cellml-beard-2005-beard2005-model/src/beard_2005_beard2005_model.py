...
"""Auto-generated CellML BioModule wrapper for Beard, 2005.

Source: physiome:beard_2005
Original: https://models.physiomeproject.org/workspace/beard_2005
"""
...
class CellmlBeard2005(biosim.BioModule):
    """BioModule wrapper for CellML model: Beard, 2005."""

    def __init__(self, model_path: str = "data/beard_2005.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Beard2005Beard2005Model = CellmlBeard2005
