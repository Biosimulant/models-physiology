...
"""Auto-generated CellML BioModule wrapper for BG_sGC.

Source: physiome:857
Original: https://models.physiomeproject.org/workspace/857
"""
...
class CellmlBgSgc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_sGC."""

    def __init__(self, model_path: str = "data/BG_sGC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
