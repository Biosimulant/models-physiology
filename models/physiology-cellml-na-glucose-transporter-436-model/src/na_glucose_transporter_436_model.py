...
"""Auto-generated CellML BioModule wrapper for Na+/Glucose Transporter.

Source: physiome:436
Original: https://models.physiomeproject.org/workspace/436
"""
...
class CellmlNaGlucoseTransporter(biosim.BioModule):
    """BioModule wrapper for CellML model: Na+/Glucose Transporter."""

    def __init__(self, model_path: str = "data/AE1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NaGlucoseTransporter436Model = CellmlNaGlucoseTransporter
