...
"""Auto-generated CellML BioModule wrapper for BG_pH_B2.

Source: physiome:884
Original: https://models.physiomeproject.org/workspace/884
"""
...
class CellmlBgPhB2(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_pH_B2."""

    def __init__(self, model_path: str = "data/BG_pH_B2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
