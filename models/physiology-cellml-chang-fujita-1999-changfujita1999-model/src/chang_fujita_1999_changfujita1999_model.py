...
"""Auto-generated CellML BioModule wrapper for Chang, Fujita, 1999.

Source: physiome:chang_fujita_1999
Original: https://models.physiomeproject.org/workspace/chang_fujita_1999
"""
...
class CellmlChangFujita1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Chang, Fujita, 1999."""

    def __init__(self, model_path: str = "data/chang_fujita_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChangFujita1999Changfujita1999Model = CellmlChangFujita1999
