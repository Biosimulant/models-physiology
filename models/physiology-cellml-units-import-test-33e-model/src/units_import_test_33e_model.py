...
"""Auto-generated CellML BioModule wrapper for units import test.

Source: physiome:33e
Original: https://models.physiomeproject.org/workspace/33e
"""
...
class CellmlUnitsImportTest(biosim.BioModule):
    """BioModule wrapper for CellML model: units import test."""

    def __init__(self, model_path: str = "data/child-model.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UnitsImportTest33eModel = CellmlUnitsImportTest
