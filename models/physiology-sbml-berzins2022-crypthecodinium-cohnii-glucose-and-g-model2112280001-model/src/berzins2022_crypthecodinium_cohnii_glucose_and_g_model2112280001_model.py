...
"""Auto-generated SBML BioModule wrapper for Berzins2022 - Crypthecodinium cohnii: glucose and glycerol uptake for production of DHA precursor acetyl-CoA.

Source: biomodels_ebi:MODEL2112280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2112280001
"""
...
class SbmlBerzins2022CrypthecodiniumCohniiGlucoseAndGlycerol(biosim.BioModule):
    """BioModule wrapper for SBML model: Berzins2022 - Crypthecodinium cohnii: glucose and glycerol uptake for production of DHA precursor acetyl-CoA."""

    def __init__(self, model_path: str = "data/MODEL2112280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Berzins2022CrypthecodiniumCohniiGlucoseAndGModel2112280001Model = SbmlBerzins2022CrypthecodiniumCohniiGlucoseAndGlycerol
