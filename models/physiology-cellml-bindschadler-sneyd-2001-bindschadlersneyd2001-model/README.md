...
**Source**: [physiome](https://models.physiomeproject.org/workspace/bindschadler_sneyd_2001)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-bindschadler-sneyd-2001-bindschadlersneyd2001-model
    alias: model
```
