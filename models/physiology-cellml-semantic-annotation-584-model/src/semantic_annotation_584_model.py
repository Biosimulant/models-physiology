...
"""Auto-generated CellML BioModule wrapper for semantic-annotation.

Source: physiome:584
Original: https://models.physiomeproject.org/workspace/584
"""
...
class CellmlSemanticAnnotation2(biosim.BioModule):
    """BioModule wrapper for CellML model: semantic-annotation."""

    def __init__(self, model_path: str = "data/De_Young_1992.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SemanticAnnotation584Model = CellmlSemanticAnnotation2
