...
"""Auto-generated CellML BioModule wrapper for BG_TCC.

Source: physiome:831
Original: https://models.physiomeproject.org/workspace/831
"""
...
class CellmlBgTcc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_TCC."""

    def __init__(self, model_path: str = "data/BG_TCC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
