...
"""Auto-generated CellML BioModule wrapper for BG_NBC.

Source: physiome:87f
Original: https://models.physiomeproject.org/workspace/87f
"""
...
class CellmlBgNbc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_NBC."""

    def __init__(self, model_path: str = "data/BG_NBC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
