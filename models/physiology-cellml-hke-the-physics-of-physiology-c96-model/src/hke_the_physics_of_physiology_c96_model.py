...
"""Auto-generated CellML BioModule wrapper for HKE - The Physics of Physiology.

Source: physiome:c96
Original: https://models.physiomeproject.org/workspace/c96
"""
...
class CellmlHkeThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: HKE - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_HKE.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HkeThePhysicsOfPhysiologyC96Model = CellmlHkeThePhysicsOfPhysiology
