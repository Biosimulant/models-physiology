...
"""Auto-generated CellML BioModule wrapper for BG_cGMP.

Source: physiome:856
Original: https://models.physiomeproject.org/workspace/856
"""
...
class CellmlBgCgmp(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_cGMP."""

    def __init__(self, model_path: str = "data/BG_cGMP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
