...
"""Auto-generated CellML BioModule wrapper for BG_GPCR_B1AR_reduced.

Source: physiome:7dc
Original: https://models.physiomeproject.org/workspace/7dc
"""
...
class CellmlBgGpcrB1arReduced(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_GPCR_B1AR_reduced."""

    def __init__(self, model_path: str = "data/BG_GPCR_B1AR_reduced.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgGpcrB1arReduced7dcModel = CellmlBgGpcrB1arReduced
