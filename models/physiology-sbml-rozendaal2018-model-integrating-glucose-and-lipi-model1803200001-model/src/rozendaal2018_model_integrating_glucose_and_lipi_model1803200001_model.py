...
"""Auto-generated SBML BioModule wrapper for Rozendaal2018 - Model Integrating Glucose and Lipid Dynamics.

Source: biomodels_ebi:MODEL1803200001
Original: https://www.ebi.ac.uk/biomodels/MODEL1803200001
"""
...
class SbmlRozendaal2018ModelIntegratingGlucoseAndLipidDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Rozendaal2018 - Model Integrating Glucose and Lipid Dynamics."""

    def __init__(self, model_path: str = "data/MODEL1803200001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rozendaal2018ModelIntegratingGlucoseAndLipiModel1803200001Model = SbmlRozendaal2018ModelIntegratingGlucoseAndLipidDynamics
