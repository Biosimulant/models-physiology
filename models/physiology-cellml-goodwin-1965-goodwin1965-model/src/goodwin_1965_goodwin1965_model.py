...
"""Auto-generated CellML BioModule wrapper for Goodwin, 1965.

Source: physiome:goodwin_1965
Original: https://models.physiomeproject.org/workspace/goodwin_1965
"""
...
class CellmlGoodwin1965(biosim.BioModule):
    """BioModule wrapper for CellML model: Goodwin, 1965."""

    def __init__(self, model_path: str = "data/goodwin_1965_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goodwin1965Goodwin1965Model = CellmlGoodwin1965
