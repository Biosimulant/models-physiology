...
"""Auto-generated CellML BioModule wrapper for FTU Heart.

Source: physiome:70b
Original: https://models.physiomeproject.org/workspace/70b
"""
...
class CellmlFtuHeart(biosim.BioModule):
    """BioModule wrapper for CellML model: FTU Heart."""

    def __init__(self, model_path: str = "data/Cardiac_FTU_v7.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FtuHeart70bModel = CellmlFtuHeart
