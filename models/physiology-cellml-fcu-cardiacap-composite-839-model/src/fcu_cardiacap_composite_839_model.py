...
"""Auto-generated CellML BioModule wrapper for FCU_cardiacAP_composite.

Source: physiome:839
Original: https://models.physiomeproject.org/workspace/839
"""
...
class CellmlFcuCardiacapComposite(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_cardiacAP_composite."""

    def __init__(self, model_path: str = "data/main.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuCardiacapComposite839Model = CellmlFcuCardiacapComposite
