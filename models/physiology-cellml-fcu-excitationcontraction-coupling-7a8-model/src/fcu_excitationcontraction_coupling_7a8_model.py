...
Source: physiome:7a8
Original: https://models.physiomeproject.org/workspace/7a8
"""
...
class CellmlFcuExcitationcontractionCoupling(biosim.BioModule):
...
FcuExcitationcontractionCoupling7a8Model = CellmlFcuExcitationcontractionCoupling
