...
"""Auto-generated CellML BioModule wrapper for Perelson 1993.

Source: physiome:perelson_kirschner_deboer_1993
Original: https://models.physiomeproject.org/workspace/perelson_kirschner_deboer_1993
"""
...
class CellmlPerelson1993(biosim.BioModule):
    """BioModule wrapper for CellML model: Perelson 1993."""

    def __init__(self, model_path: str = "data/perelson_1993a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Perelson1993Perelsonkirschnerdeboer1993Model = CellmlPerelson1993
