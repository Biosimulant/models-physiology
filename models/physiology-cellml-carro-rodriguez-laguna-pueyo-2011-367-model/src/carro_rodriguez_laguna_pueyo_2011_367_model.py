...
"""Auto-generated CellML BioModule wrapper for Carro, Rodriguez, Laguna, Pueyo (2011).

Source: physiome:367
Original: https://models.physiomeproject.org/workspace/367
"""
...
class CellmlCarroRodriguezLagunaPueyo20112(biosim.BioModule):
    """BioModule wrapper for CellML model: Carro, Rodriguez, Laguna, Pueyo (2011)."""

    def __init__(self, model_path: str = "data/Carro_Rodriguez_Laguna_Pueyo_2011_ENDO.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CarroRodriguezLagunaPueyo2011367Model = CellmlCarroRodriguezLagunaPueyo20112
