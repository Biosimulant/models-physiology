...
**Source**: [physiome](https://models.physiomeproject.org/workspace/367)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-carro-rodriguez-laguna-pueyo-2011-367-model/model.yaml
```
