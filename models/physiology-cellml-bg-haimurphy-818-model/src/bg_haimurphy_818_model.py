...
"""Auto-generated CellML BioModule wrapper for BG_HaiMurphy.

Source: physiome:818
Original: https://models.physiomeproject.org/workspace/818
"""
...
class CellmlBgHaimurphy(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_HaiMurphy."""

    def __init__(self, model_path: str = "data/BG_HaiMurphy.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgHaimurphy818Model = CellmlBgHaimurphy
