...
"""Auto-generated CellML BioModule wrapper for Workspace Annotations.

Source: physiome:557
Original: https://models.physiomeproject.org/workspace/557
"""
...
class CellmlWorkspaceAnnotations(biosim.BioModule):
    """BioModule wrapper for CellML model: Workspace Annotations."""

    def __init__(self, model_path: str = "data/acikgoz_2009a.cellml_annotations.rdf", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WorkspaceAnnotations557Model = CellmlWorkspaceAnnotations
