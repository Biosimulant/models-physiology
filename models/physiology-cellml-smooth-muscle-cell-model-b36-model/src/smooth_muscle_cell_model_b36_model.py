...
"""Auto-generated CellML BioModule wrapper for Smooth Muscle Cell Model.

Source: physiome:b36
Original: https://models.physiomeproject.org/workspace/b36
"""
...
class CellmlSmoothMuscleCellModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Smooth Muscle Cell Model."""

    def __init__(self, model_path: str = "data/Main_SMC_Model.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SmoothMuscleCellModelB36Model = CellmlSmoothMuscleCellModel
