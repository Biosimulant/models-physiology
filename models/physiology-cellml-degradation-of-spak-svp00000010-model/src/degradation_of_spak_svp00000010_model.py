...
"""Auto-generated CellML BioModule wrapper for Degradation of spaK.

Source: physiome:SVP_00000010
Original: https://models.physiomeproject.org/workspace/SVP_00000010
"""
...
class CellmlDegradationOfSpak(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of spaK."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_spaK.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfSpakSvp00000010Model = CellmlDegradationOfSpak
