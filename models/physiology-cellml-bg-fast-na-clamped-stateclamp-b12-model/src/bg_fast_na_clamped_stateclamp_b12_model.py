...
"""Auto-generated CellML BioModule wrapper for BG_fast_Na_clamped_stateclamp.

Source: physiome:b12
Original: https://models.physiomeproject.org/workspace/b12
"""
...
class CellmlBgFastNaClampedStateclamp(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_fast_Na_clamped_stateclamp."""

    def __init__(self, model_path: str = "data/BG_fast_Na_clamped_stateclamp.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgFastNaClampedStateclampB12Model = CellmlBgFastNaClampedStateclamp
