...
"""Auto-generated CellML BioModule wrapper for LG_Na_voltage_clamp.

Source: physiome:b10
Original: https://models.physiomeproject.org/workspace/b10
"""
...
class CellmlLgNaVoltageClamp(biosim.BioModule):
    """BioModule wrapper for CellML model: LG_Na_voltage_clamp."""

    def __init__(self, model_path: str = "data/LG_Na_voltage_clamp.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LgNaVoltageClampB10Model = CellmlLgNaVoltageClamp
