...
"""Auto-generated CellML BioModule wrapper for BG PMCA uSMC.

Source: physiome:d28
Original: https://models.physiomeproject.org/workspace/d28
"""
...
class CellmlBgPmcaUsmc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG PMCA uSMC."""

    def __init__(self, model_path: str = "data/Higgins_SERCA_to_PMCA_wVm_v1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgPmcaUsmcD28Model = CellmlBgPmcaUsmc
