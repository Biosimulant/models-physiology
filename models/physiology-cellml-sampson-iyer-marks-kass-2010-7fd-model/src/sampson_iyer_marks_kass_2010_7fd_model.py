...
"""Auto-generated CellML BioModule wrapper for Sampson-Iyer-Marks-Kass-2010.

Source: physiome:7fd
Original: https://models.physiomeproject.org/workspace/7fd
"""
...
class CellmlSampsonIyerMarksKass2010(biosim.BioModule):
    """BioModule wrapper for CellML model: Sampson-Iyer-Marks-Kass-2010."""

    def __init__(self, model_path: str = "data/sampson-2010.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SampsonIyerMarksKass20107fdModel = CellmlSampsonIyerMarksKass2010
