...
"""Auto-generated CellML BioModule wrapper for Blood HbO2 and HbCO2 Dissociation Curves.

Source: physiome:607
Original: https://models.physiomeproject.org/workspace/607
"""
...
class CellmlBloodHbo2AndHbco2DissociationCurves(biosim.BioModule):
    """BioModule wrapper for CellML model: Blood HbO2 and HbCO2 Dissociation Curves."""

    def __init__(self, model_path: str = "data/Figure01_1_.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BloodHbo2AndHbco2DissociationCurves607Model = CellmlBloodHbo2AndHbco2DissociationCurves
