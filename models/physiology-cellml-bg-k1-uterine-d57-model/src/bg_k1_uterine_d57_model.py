...
"""Auto-generated CellML BioModule wrapper for BG_K1_uterine.

Source: physiome:d57
Original: https://models.physiomeproject.org/workspace/d57
"""
...
class CellmlBgK1Uterine(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_K1_uterine."""

    def __init__(self, model_path: str = "data/BG_K1_uterine.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgK1UterineD57Model = CellmlBgK1Uterine
