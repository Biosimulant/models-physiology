...
"""Auto-generated CellML BioModule wrapper for EColi Chassis.

Source: physiome:SVP_00000032
Original: https://models.physiomeproject.org/workspace/SVP_00000032
"""
...
class CellmlEcoliChassis(biosim.BioModule):
    """BioModule wrapper for CellML model: EColi Chassis."""

    def __init__(self, model_path: str = "data/Chassis_EColi.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EcoliChassisSvp00000032Model = CellmlEcoliChassis
