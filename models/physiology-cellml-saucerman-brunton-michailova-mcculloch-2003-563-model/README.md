...
**Source**: [physiome](https://models.physiomeproject.org/workspace/563)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-saucerman-brunton-michailova-mcculloch-2003-563-model/model.yaml
```
