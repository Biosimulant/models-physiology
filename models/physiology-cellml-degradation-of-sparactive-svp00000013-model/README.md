...
**Source**: [physiome](https://models.physiomeproject.org/workspace/SVP_00000013)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-degradation-of-sparactive-svp00000013-model/model.yaml
```
