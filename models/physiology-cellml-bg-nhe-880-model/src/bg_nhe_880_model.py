...
"""Auto-generated CellML BioModule wrapper for BG_NHE.

Source: physiome:880
Original: https://models.physiomeproject.org/workspace/880
"""
...
class CellmlBgNhe(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_NHE."""

    def __init__(self, model_path: str = "data/BG_NHE.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
