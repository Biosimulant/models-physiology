...
"""Auto-generated CellML BioModule wrapper for Dixit, Perelson, 2004.

Source: physiome:dixit_perelson_2004
Original: https://models.physiomeproject.org/workspace/dixit_perelson_2004
"""
...
class CellmlDixitPerelson2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Dixit, Perelson, 2004."""

    def __init__(self, model_path: str = "data/dixit_perelson_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DixitPerelson2004Dixitperelson2004Model = CellmlDixitPerelson2004
