...
"""Auto-generated CellML BioModule wrapper for Karagiannis, Popel, 2006.

Source: physiome:karagiannis_popel_2006
Original: https://models.physiomeproject.org/workspace/karagiannis_popel_2006
"""
...
class CellmlKaragiannisPopel2006(biosim.BioModule):
    """BioModule wrapper for CellML model: Karagiannis, Popel, 2006."""

    def __init__(self, model_path: str = "data/karagiannis_popel_2006.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KaragiannisPopel2006Karagiannispopel2006Model = CellmlKaragiannisPopel2006
