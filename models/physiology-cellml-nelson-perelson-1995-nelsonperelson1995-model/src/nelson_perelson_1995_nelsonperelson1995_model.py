...
"""Auto-generated CellML BioModule wrapper for Nelson, Perelson 1995.

Source: physiome:nelson_perelson_1995
Original: https://models.physiomeproject.org/workspace/nelson_perelson_1995
"""
...
class CellmlNelsonPerelson1995(biosim.BioModule):
    """BioModule wrapper for CellML model: Nelson, Perelson 1995."""

    def __init__(self, model_path: str = "data/nelson_1995a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NelsonPerelson1995Nelsonperelson1995Model = CellmlNelsonPerelson1995
