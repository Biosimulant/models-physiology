...
"""Auto-generated CellML BioModule wrapper for Nagano and Gerritsen, 2001.

Source: physiome:nagano_gerritsen_2001
Original: https://models.physiomeproject.org/workspace/nagano_gerritsen_2001
"""
...
class CellmlNaganoAndGerritsen2001(biosim.BioModule):
    """BioModule wrapper for CellML model: Nagano and Gerritsen, 2001."""

    def __init__(self, model_path: str = "data/nagano_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NaganoAndGerritsen2001Naganogerritsen2001Model = CellmlNaganoAndGerritsen2001
