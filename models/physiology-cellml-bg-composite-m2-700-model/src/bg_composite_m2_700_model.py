...
"""Auto-generated CellML BioModule wrapper for BG_composite_M2.

Source: physiome:700
Original: https://models.physiomeproject.org/workspace/700
"""
...
class CellmlBgCompositeM2(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_composite_M2."""

    def __init__(self, model_path: str = "data/BG_M2_composite.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgCompositeM2700Model = CellmlBgCompositeM2
