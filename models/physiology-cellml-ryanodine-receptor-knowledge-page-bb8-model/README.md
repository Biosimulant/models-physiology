...
**Source**: [physiome](https://models.physiomeproject.org/workspace/bb8)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-ryanodine-receptor-knowledge-page-bb8-model/model.yaml
```
