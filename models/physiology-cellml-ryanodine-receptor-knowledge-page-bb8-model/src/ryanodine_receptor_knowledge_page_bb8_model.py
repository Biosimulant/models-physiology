...
"""Auto-generated CellML BioModule wrapper for Ryanodine receptor knowledge page.

Source: physiome:bb8
Original: https://models.physiomeproject.org/workspace/bb8
"""
...
class CellmlRyanodineReceptorKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: Ryanodine receptor knowledge page."""

    def __init__(self, model_path: str = "data/BG_RyR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RyanodineReceptorKnowledgePageBb8Model = CellmlRyanodineReceptorKnowledgePage
