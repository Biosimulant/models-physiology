...
"""Auto-generated CellML BioModule wrapper for Aslanidi 2009.

Source: physiome:aslanidi_purkinje_model_2009
Original: https://models.physiomeproject.org/workspace/aslanidi_purkinje_model_2009
"""
...
class CellmlAslanidi20092(biosim.BioModule):
    """BioModule wrapper for CellML model: Aslanidi 2009."""

    def __init__(self, model_path: str = "data/aslanidi_2009.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aslanidi2009Aslanidipurkinjemodel2009Model = CellmlAslanidi20092
