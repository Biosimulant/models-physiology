...
"""Auto-generated CellML BioModule wrapper for BG_NSCC.

Source: physiome:d54
Original: https://models.physiomeproject.org/workspace/d54
"""
...
class CellmlBgNscc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_NSCC."""

    def __init__(self, model_path: str = "data/BG_NSCC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
