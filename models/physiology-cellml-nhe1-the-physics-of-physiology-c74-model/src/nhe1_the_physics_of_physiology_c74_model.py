...
"""Auto-generated CellML BioModule wrapper for NHE1 - The Physics of Physiology.

Source: physiome:c74
Original: https://models.physiomeproject.org/workspace/c74
"""
...
class CellmlNhe1ThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: NHE1 - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_NHE1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nhe1ThePhysicsOfPhysiologyC74Model = CellmlNhe1ThePhysicsOfPhysiology
