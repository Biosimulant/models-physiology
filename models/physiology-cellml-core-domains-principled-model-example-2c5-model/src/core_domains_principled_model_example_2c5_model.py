...
"""Auto-generated CellML BioModule wrapper for Core Domains Principled Model Example.

Source: physiome:2c5
Original: https://models.physiomeproject.org/workspace/2c5
"""
...
class CellmlCoreDomainsPrincipledModelExample(biosim.BioModule):
    """BioModule wrapper for CellML model: Core Domains Principled Model Example."""

    def __init__(self, model_path: str = "data/ACoreDomainsExample.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CoreDomainsPrincipledModelExample2c5Model = CellmlCoreDomainsPrincipledModelExample
