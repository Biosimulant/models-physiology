...
"""Auto-generated CellML BioModule wrapper for BG_GsProtein_sneyd.

Source: physiome:6cb
Original: https://models.physiomeproject.org/workspace/6cb
"""
...
class CellmlBgGsproteinSneyd(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_GsProtein_sneyd."""

    def __init__(self, model_path: str = "data/BG_GsProtein.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgGsproteinSneyd6cbModel = CellmlBgGsproteinSneyd
