...
**Source**: [physiome](https://models.physiomeproject.org/workspace/5b6)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-inner-medullary-lactate-production-and-accumulat-5b6-model
    alias: model
```
