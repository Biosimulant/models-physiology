...
"""Auto-generated CellML BioModule wrapper for Iber, Maini, 2002.

Source: physiome:iber_maini_2002
Original: https://models.physiomeproject.org/workspace/iber_maini_2002
"""
...
class CellmlIberMaini2002(biosim.BioModule):
    """BioModule wrapper for CellML model: Iber, Maini, 2002."""

    def __init__(self, model_path: str = "data/iber_maini_2002.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
IberMaini2002Ibermaini2002Model = CellmlIberMaini2002
