...
**Source**: [physiome](https://models.physiomeproject.org/workspace/lenbury_pornsawad_2005)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-lenbury-pornsawad-2005-lenburypornsawad2005-model
    alias: model
```
