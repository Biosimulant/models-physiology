...
"""Auto-generated CellML BioModule wrapper for Lenbury, Pornsawad, 2005.

Source: physiome:lenbury_pornsawad_2005
Original: https://models.physiomeproject.org/workspace/lenbury_pornsawad_2005
"""
...
class CellmlLenburyPornsawad2005(biosim.BioModule):
    """BioModule wrapper for CellML model: Lenbury, Pornsawad, 2005."""

    def __init__(self, model_path: str = "data/lenbury_pornsawad_2005.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LenburyPornsawad2005Lenburypornsawad2005Model = CellmlLenburyPornsawad2005
