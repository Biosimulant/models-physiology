...
**Source**: [physiome](https://models.physiomeproject.org/workspace/3e0)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-a-model-for-pacemaking-in-substantia-nigra-neuro-3e0-model
    alias: model
```
