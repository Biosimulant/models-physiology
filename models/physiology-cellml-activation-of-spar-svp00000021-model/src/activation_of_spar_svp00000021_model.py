...
"""Auto-generated CellML BioModule wrapper for Activation of spaR.

Source: physiome:SVP_00000021
Original: https://models.physiomeproject.org/workspace/SVP_00000021
"""
...
class CellmlActivationOfSpar(biosim.BioModule):
    """BioModule wrapper for CellML model: Activation of spaR."""

    def __init__(self, model_path: str = "data/Bioenvironment_RxR2P1_spaRActivation.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ActivationOfSparSvp00000021Model = CellmlActivationOfSpar
