...
"""Auto-generated CellML BioModule wrapper for Gerard and Goldbeter 2009.

Source: physiome:gerard_goldbeter_2009
Original: https://models.physiomeproject.org/workspace/gerard_goldbeter_2009
"""
...
class CellmlGerardAndGoldbeter20092(biosim.BioModule):
    """BioModule wrapper for CellML model: Gerard and Goldbeter 2009."""

    def __init__(self, model_path: str = "data/gerard_2009.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GerardAndGoldbeter2009Gerardgoldbeter2009Model = CellmlGerardAndGoldbeter20092
