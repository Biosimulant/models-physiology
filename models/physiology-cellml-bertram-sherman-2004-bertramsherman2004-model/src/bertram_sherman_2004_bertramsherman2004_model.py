...
"""Auto-generated CellML BioModule wrapper for Bertram, Sherman, 2004.

Source: physiome:bertram_sherman_2004
Original: https://models.physiomeproject.org/workspace/bertram_sherman_2004
"""
...
class CellmlBertramSherman2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Bertram, Sherman, 2004."""

    def __init__(self, model_path: str = "data/bertram_sherman_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BertramSherman2004Bertramsherman2004Model = CellmlBertramSherman2004
