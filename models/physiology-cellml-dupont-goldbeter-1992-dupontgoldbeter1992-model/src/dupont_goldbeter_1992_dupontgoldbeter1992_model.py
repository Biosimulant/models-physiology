...
"""Auto-generated CellML BioModule wrapper for Dupont Goldbeter 1992.

Source: physiome:dupont_goldbeter_1992
Original: https://models.physiomeproject.org/workspace/dupont_goldbeter_1992
"""
...
class CellmlDupontGoldbeter1992(biosim.BioModule):
    """BioModule wrapper for CellML model: Dupont Goldbeter 1992."""

    def __init__(self, model_path: str = "data/dupont_1992_1.1model.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DupontGoldbeter1992Dupontgoldbeter1992Model = CellmlDupontGoldbeter1992
