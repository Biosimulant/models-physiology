...
**Source**: [physiome](https://models.physiomeproject.org/workspace/dupont_goldbeter_1992)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-dupont-goldbeter-1992-dupontgoldbeter1992-model
    alias: model
```
