...
"""Auto-generated CellML BioModule wrapper for David Cumin PhD Model.

Source: physiome:david_cumin_phd_model
Original: https://models.physiomeproject.org/workspace/david_cumin_phd_model
"""
...
class CellmlDavidCuminPhdModel(biosim.BioModule):
    """BioModule wrapper for CellML model: David Cumin PhD Model."""

    def __init__(self, model_path: str = "data/FINAL.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DavidCuminPhdModelDavidcuminphdmodelModel = CellmlDavidCuminPhdModel
