...
"""Auto-generated CellML BioModule wrapper for Formation of IC.

Source: physiome:SVP_00000018
Original: https://models.physiomeproject.org/workspace/SVP_00000018
"""
...
class CellmlFormationOfIc(biosim.BioModule):
    """BioModule wrapper for CellML model: Formation of IC."""

    def __init__(self, model_path: str = "data/Bioenvironment_RxR1P1MM_ICFormation.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FormationOfIcSvp00000018Model = CellmlFormationOfIc
