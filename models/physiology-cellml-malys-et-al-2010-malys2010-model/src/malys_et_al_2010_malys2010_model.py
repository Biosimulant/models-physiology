...
"""Auto-generated CellML BioModule wrapper for Malys et al. 2010.

Source: physiome:malys_2010
Original: https://models.physiomeproject.org/workspace/malys_2010
"""
...
class CellmlMalysEtAl2010(biosim.BioModule):
    """BioModule wrapper for CellML model: Malys et al. 2010."""

    def __init__(self, model_path: str = "data/malys_2010.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MalysEtAl2010Malys2010Model = CellmlMalysEtAl2010
