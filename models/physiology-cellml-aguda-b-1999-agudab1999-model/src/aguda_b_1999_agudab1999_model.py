...
"""Auto-generated CellML BioModule wrapper for Aguda, B, 1999.

Source: physiome:aguda_b_1999
Original: https://models.physiomeproject.org/workspace/aguda_b_1999
"""
...
class CellmlAgudaB19992(biosim.BioModule):
    """BioModule wrapper for CellML model: Aguda, B, 1999."""

    def __init__(self, model_path: str = "data/aguda_b_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AgudaB1999Agudab1999Model = CellmlAgudaB19992
