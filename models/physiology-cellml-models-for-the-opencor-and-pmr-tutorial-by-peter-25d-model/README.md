...
**Source**: [physiome](https://models.physiomeproject.org/workspace/25d)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-models-for-the-opencor-and-pmr-tutorial-by-peter-25d-model
    alias: model
```
