...
"""Auto-generated CellML BioModule wrapper for BG_CHE.

Source: physiome:881
Original: https://models.physiomeproject.org/workspace/881
"""
...
class CellmlBgChe(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_CHE."""

    def __init__(self, model_path: str = "data/BG_CHE.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
