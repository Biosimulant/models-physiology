...
"""Auto-generated CellML BioModule wrapper for Li, Smith, 2009.

Source: physiome:li_smith_2009
Original: https://models.physiomeproject.org/workspace/li_smith_2009
"""
...
class CellmlLiSmith2009(biosim.BioModule):
    """BioModule wrapper for CellML model: Li, Smith, 2009."""

    def __init__(self, model_path: str = "data/C57BL7_WT_model_version1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LiSmith2009Lismith2009Model = CellmlLiSmith2009
