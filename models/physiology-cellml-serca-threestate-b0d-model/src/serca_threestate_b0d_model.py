...
"""Auto-generated CellML BioModule wrapper for SERCA_ThreeState.

Source: physiome:b0d
Original: https://models.physiomeproject.org/workspace/b0d
"""
...
class CellmlSercaThreestate(biosim.BioModule):
    """BioModule wrapper for CellML model: SERCA_ThreeState."""

    def __init__(self, model_path: str = "data/SERCA_ThreeState.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SercaThreestateB0dModel = CellmlSercaThreestate
