...
"""Auto-generated CellML BioModule wrapper for Moore, Li, 2004.

Source: physiome:moore_li_2004
Original: https://models.physiomeproject.org/workspace/moore_li_2004
"""
...
class CellmlMooreLi20042(biosim.BioModule):
    """BioModule wrapper for CellML model: Moore, Li, 2004."""

    def __init__(self, model_path: str = "data/moore_li_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MooreLi2004Mooreli2004Model = CellmlMooreLi20042
