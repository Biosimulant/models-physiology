...
"""Auto-generated CellML BioModule wrapper for KACh protein knowledge page.

Source: physiome:bc6
Original: https://models.physiomeproject.org/workspace/bc6
"""
...
class CellmlKachProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: KACh protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_KACh.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KachProteinKnowledgePageBc6Model = CellmlKachProteinKnowledgePage
