...
"""Auto-generated CellML BioModule wrapper for McIntyre, Richardson, Grill, 2001.

Source: physiome:5f5
Original: https://models.physiomeproject.org/workspace/5f5
"""
...
class CellmlMcintyreRichardsonGrill2001(biosim.BioModule):
    """BioModule wrapper for CellML model: McIntyre, Richardson, Grill, 2001."""

    def __init__(self, model_path: str = "data/mcintyre_richardson_grill_model_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
McintyreRichardsonGrill20015f5Model = CellmlMcintyreRichardsonGrill2001
