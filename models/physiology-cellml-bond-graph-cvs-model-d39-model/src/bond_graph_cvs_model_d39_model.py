...
"""Auto-generated CellML BioModule wrapper for Bond graph CVS model.

Source: physiome:d39
Original: https://models.physiomeproject.org/workspace/d39
"""
...
class CellmlBondGraphCvsModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Bond graph CVS model."""

    def __init__(self, model_path: str = "data/BG_cvs_MVP_model.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BondGraphCvsModelD39Model = CellmlBondGraphCvsModel
