...
"""Auto-generated CellML BioModule wrapper for Degradation of spaR.

Source: physiome:SVP_00000012
Original: https://models.physiomeproject.org/workspace/SVP_00000012
"""
...
class CellmlDegradationOfSpar(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of spaR."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_spaR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfSparSvp00000012Model = CellmlDegradationOfSpar
