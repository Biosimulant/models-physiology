...
"""Auto-generated CellML BioModule wrapper for SGLT1 - The Physics of Physiology.

Source: physiome:c6c
Original: https://models.physiomeproject.org/workspace/c6c
"""
...
class CellmlSglt1ThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: SGLT1 - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_SGLT1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sglt1ThePhysicsOfPhysiologyC6cModel = CellmlSglt1ThePhysicsOfPhysiology
