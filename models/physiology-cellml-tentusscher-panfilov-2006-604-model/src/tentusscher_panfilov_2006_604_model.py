...
Source: physiome:604
Original: https://models.physiomeproject.org/workspace/604
"""
...
class CellmlTentusscherPanfilov2006(biosim.BioModule):
    """BioModule wrapper for CellML model: Tentusscher, Panfilov, 2006."""

    def __init__(self, model_path: str = "data/ten_tusscher_model_2006_endo.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TentusscherPanfilov2006604Model = CellmlTentusscherPanfilov2006
