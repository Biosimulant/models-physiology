...
"""Auto-generated CellML BioModule wrapper for Protein CDS for spaK.

Source: physiome:SVP_00000026
Original: https://models.physiomeproject.org/workspace/SVP_00000026
"""
...
class CellmlProteinCdsForSpak(biosim.BioModule):
    """BioModule wrapper for CellML model: Protein CDS for spaK."""

    def __init__(self, model_path: str = "data/Bugbuster_ProteinCDS_spaK.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ProteinCdsForSpakSvp00000026Model = CellmlProteinCdsForSpak
