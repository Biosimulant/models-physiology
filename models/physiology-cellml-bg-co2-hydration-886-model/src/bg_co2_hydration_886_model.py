...
"""Auto-generated CellML BioModule wrapper for BG_CO2_hydration.

Source: physiome:886
Original: https://models.physiomeproject.org/workspace/886
"""
...
class CellmlBgCo2Hydration(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_CO2_hydration."""

    def __init__(self, model_path: str = "data/BG_CO2_hyd.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgCo2Hydration886Model = CellmlBgCo2Hydration
