...
"""Auto-generated CellML BioModule wrapper for BG_PLC.

Source: physiome:848
Original: https://models.physiomeproject.org/workspace/848
"""
...
class CellmlBgPlc(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_PLC."""

    def __init__(self, model_path: str = "data/BG_PLC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
