...
"""Auto-generated CellML BioModule wrapper for Novak, Tyson, 1993.

Source: physiome:novak_tyson_1993
Original: https://models.physiomeproject.org/workspace/novak_tyson_1993
"""
...
class CellmlNovakTyson19932(biosim.BioModule):
    """BioModule wrapper for CellML model: Novak, Tyson, 1993."""

    def __init__(self, model_path: str = "data/novak_tyson_1993_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NovakTyson1993Novaktyson1993Model = CellmlNovakTyson19932
