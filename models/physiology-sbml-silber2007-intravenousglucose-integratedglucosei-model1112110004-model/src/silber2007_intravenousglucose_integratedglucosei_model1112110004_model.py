...
"""Auto-generated SBML BioModule wrapper for Silber2007_IntravenousGlucose_IntegratedGlucoseInsulinModel.

Source: biomodels_ebi:MODEL1112110004
Original: https://www.ebi.ac.uk/biomodels/MODEL1112110004
"""
...
class SbmlSilber2007IntravenousglucoseIntegratedglucoseinsulinmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Silber2007_IntravenousGlucose_IntegratedGlucoseInsulinModel."""

    def __init__(self, model_path: str = "data/MODEL1112110004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Silber2007IntravenousglucoseIntegratedglucoseiModel1112110004Model = SbmlSilber2007IntravenousglucoseIntegratedglucoseinsulinmodel
