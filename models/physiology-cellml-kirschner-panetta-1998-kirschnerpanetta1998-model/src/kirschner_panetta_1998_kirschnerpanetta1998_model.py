...
"""Auto-generated CellML BioModule wrapper for Kirschner, Panetta, 1998.

Source: physiome:kirschner_panetta_1998
Original: https://models.physiomeproject.org/workspace/kirschner_panetta_1998
"""
...
class CellmlKirschnerPanetta1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Kirschner, Panetta, 1998."""

    def __init__(self, model_path: str = "data/kirschner_panetta_1998.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KirschnerPanetta1998Kirschnerpanetta1998Model = CellmlKirschnerPanetta1998
