...
"""Auto-generated CellML BioModule wrapper for BG_fast_Na.

Source: physiome:826
Original: https://models.physiomeproject.org/workspace/826
"""
...
class CellmlBgFastNa(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_fast_Na."""

    def __init__(self, model_path: str = "data/BG_fast_Na.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgFastNa826Model = CellmlBgFastNa
