...
"""Auto-generated SBML BioModule wrapper for Topp200 -  Model of b-Cell Mass, Insulin, and Glucose Kinetics:Pathways to Diabetes.

Source: biomodels_ebi:MODEL2001080002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001080002
"""
...
class SbmlTopp200ModelOfBCellMassInsulinAndGlucoseKinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Topp200 -  Model of b-Cell Mass, Insulin, and Glucose Kinetics:Pathways to Diabetes."""

    def __init__(self, model_path: str = "data/MODEL2001080002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Topp200ModelOfBCellMassInsulinAndGlucoseModel2001080002Model = SbmlTopp200ModelOfBCellMassInsulinAndGlucoseKinetics
