...
"""Auto-generated CellML BioModule wrapper for FCU_ExcitationContraction_Coupling.

Source: physiome:8a0
Original: https://models.physiomeproject.org/workspace/8a0
"""
...
class CellmlFcuExcitationcontractionCoupling2(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_ExcitationContraction_Coupling."""

    def __init__(self, model_path: str = "data/FCU_EC_coupling.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuExcitationcontractionCoupling8a0Model = CellmlFcuExcitationcontractionCoupling2
