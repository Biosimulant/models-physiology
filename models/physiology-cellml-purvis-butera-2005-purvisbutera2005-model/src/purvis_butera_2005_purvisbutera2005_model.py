...
"""Auto-generated CellML BioModule wrapper for Purvis, Butera, 2005.

Source: physiome:purvis_butera_2005
Original: https://models.physiomeproject.org/workspace/purvis_butera_2005
"""
...
class CellmlPurvisButera20052(biosim.BioModule):
    """BioModule wrapper for CellML model: Purvis, Butera, 2005."""

    def __init__(self, model_path: str = "data/purvis_butera_2005.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PurvisButera2005Purvisbutera2005Model = CellmlPurvisButera20052
