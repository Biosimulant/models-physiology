...
**Source**: [physiome](https://models.physiomeproject.org/workspace/aee)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-the-physics-of-physiology-example-2-a-mechanical-aee-model
    alias: model
```
