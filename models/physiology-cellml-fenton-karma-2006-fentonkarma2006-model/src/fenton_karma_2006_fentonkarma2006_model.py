...
"""Auto-generated CellML BioModule wrapper for Fenton, Karma, 2006.

Source: physiome:fenton_karma_2006
Original: https://models.physiomeproject.org/workspace/fenton_karma_2006
"""
...
class CellmlFentonKarma2006(biosim.BioModule):
    """BioModule wrapper for CellML model: Fenton, Karma, 2006."""

    def __init__(self, model_path: str = "data/fenton_karma_2006.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FentonKarma2006Fentonkarma2006Model = CellmlFentonKarma2006
