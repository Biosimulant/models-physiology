...
"""Auto-generated CellML BioModule wrapper for Peterson and Riggs, 2010.

Source: physiome:peterson_riggs_2010
Original: https://models.physiomeproject.org/workspace/peterson_riggs_2010
"""
...
class CellmlPetersonAndRiggs2010(biosim.BioModule):
    """BioModule wrapper for CellML model: Peterson and Riggs, 2010."""

    def __init__(self, model_path: str = "data/peterson_2010.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetersonAndRiggs2010Petersonriggs2010Model = CellmlPetersonAndRiggs2010
