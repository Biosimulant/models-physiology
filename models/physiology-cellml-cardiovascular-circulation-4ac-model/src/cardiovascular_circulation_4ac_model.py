...
"""Auto-generated CellML BioModule wrapper for Cardiovascular Circulation.

Source: physiome:4ac
Original: https://models.physiomeproject.org/workspace/4ac
"""
...
class CellmlCardiovascularCirculation(biosim.BioModule):
    """BioModule wrapper for CellML model: Cardiovascular Circulation."""

    def __init__(self, model_path: str = "data/BG_ADV.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CardiovascularCirculation4acModel = CellmlCardiovascularCirculation
