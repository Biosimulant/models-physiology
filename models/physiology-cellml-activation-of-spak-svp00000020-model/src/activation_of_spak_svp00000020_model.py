...
"""Auto-generated CellML BioModule wrapper for Activation of spaK.

Source: physiome:SVP_00000020
Original: https://models.physiomeproject.org/workspace/SVP_00000020
"""
...
class CellmlActivationOfSpak(biosim.BioModule):
    """BioModule wrapper for CellML model: Activation of spaK."""

    def __init__(self, model_path: str = "data/Bioenvironment_RxR2P1_spaKActivation.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ActivationOfSpakSvp00000020Model = CellmlActivationOfSpak
