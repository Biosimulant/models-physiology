...
"""Auto-generated CellML BioModule wrapper for ShelleyCardiacAPModel.

Source: physiome:b15
Original: https://models.physiomeproject.org/workspace/b15
"""
...
class CellmlShelleycardiacapmodel(biosim.BioModule):
    """BioModule wrapper for CellML model: ShelleyCardiacAPModel."""

    def __init__(self, model_path: str = "data/BG_K1_MichaelParameters.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ShelleycardiacapmodelB15Model = CellmlShelleycardiacapmodel
