...
"""Auto-generated CellML BioModule wrapper for BG_pH_B1.

Source: physiome:883
Original: https://models.physiomeproject.org/workspace/883
"""
...
class CellmlBgPhB1(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_pH_B1."""

    def __init__(self, model_path: str = "data/BG_pH_B1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
