...
"""Auto-generated CellML BioModule wrapper for Devries, Sherman, 2001.

Source: physiome:devries_sherman_2001
Original: https://models.physiomeproject.org/workspace/devries_sherman_2001
"""
...
class CellmlDevriesSherman2001(biosim.BioModule):
    """BioModule wrapper for CellML model: Devries, Sherman, 2001."""

    def __init__(self, model_path: str = "data/devries_sherman_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DevriesSherman2001Devriessherman2001Model = CellmlDevriesSherman2001
