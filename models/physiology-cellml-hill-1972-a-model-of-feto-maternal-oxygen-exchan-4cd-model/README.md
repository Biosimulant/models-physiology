...
**Source**: [physiome](https://models.physiomeproject.org/workspace/4cd)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-hill-1972-a-model-of-feto-maternal-oxygen-exchan-4cd-model/model.yaml
```
