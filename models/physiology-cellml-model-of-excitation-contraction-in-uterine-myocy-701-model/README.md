...
**Source**: [physiome](https://models.physiomeproject.org/workspace/701)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-model-of-excitation-contraction-in-uterine-myocy-701-model/model.yaml
```
