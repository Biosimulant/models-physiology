...
"""Auto-generated CellML BioModule wrapper for Clancy, Rudy, 2002.

Source: physiome:clancy_rudy_2002
Original: https://models.physiomeproject.org/workspace/clancy_rudy_2002
"""
...
class CellmlClancyRudy2002(biosim.BioModule):
    """BioModule wrapper for CellML model: Clancy, Rudy, 2002."""

    def __init__(self, model_path: str = "data/clancy_rudy_2002.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ClancyRudy2002Clancyrudy2002Model = CellmlClancyRudy2002
