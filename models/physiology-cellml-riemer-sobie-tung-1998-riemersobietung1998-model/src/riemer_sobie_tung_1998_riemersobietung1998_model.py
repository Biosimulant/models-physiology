...
"""Auto-generated CellML BioModule wrapper for Riemer, Sobie, Tung, 1998.

Source: physiome:riemer_sobie_tung_1998
Original: https://models.physiomeproject.org/workspace/riemer_sobie_tung_1998
"""
...
class CellmlRiemerSobieTung1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Riemer, Sobie, Tung, 1998."""

    def __init__(self, model_path: str = "data/riemer_sobie_tung_1998.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RiemerSobieTung1998Riemersobietung1998Model = CellmlRiemerSobieTung1998
