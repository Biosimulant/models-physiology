...
"""Auto-generated CellML BioModule wrapper for Lokta, Volterra.

Source: physiome:lokta_volterra
Original: https://models.physiomeproject.org/workspace/lokta_volterra
"""
...
class CellmlLoktaVolterra(biosim.BioModule):
    """BioModule wrapper for CellML model: Lokta, Volterra."""

    def __init__(self, model_path: str = "data/lokta_volterra_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LoktaVolterraLoktavolterraModel = CellmlLoktaVolterra
