...
"""Auto-generated CellML BioModule wrapper for Kp protein knowledge page.

Source: physiome:bcf
Original: https://models.physiomeproject.org/workspace/bcf
"""
...
class CellmlKpProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: Kp protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_Kp.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KpProteinKnowledgePageBcfModel = CellmlKpProteinKnowledgePage
