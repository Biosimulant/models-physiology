...
"""Auto-generated CellML BioModule wrapper for Formation of TFS.

Source: physiome:SVP_00000022
Original: https://models.physiomeproject.org/workspace/SVP_00000022
"""
...
class CellmlFormationOfTfs(biosim.BioModule):
    """BioModule wrapper for CellML model: Formation of TFS."""

    def __init__(self, model_path: str = "data/Bioenvironment_RxR2P1Rev_TFSFormation.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FormationOfTfsSvp00000022Model = CellmlFormationOfTfs
