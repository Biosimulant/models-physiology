...
**Source**: [physiome](https://models.physiomeproject.org/workspace/af4)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-the-physics-of-physiology-example-8-membrane-ion-af4-model
    alias: model
```
