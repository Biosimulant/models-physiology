...
"""Auto-generated CellML BioModule wrapper for Bertram et al. (2011) Lymphangion Model.

Source: physiome:b44
Original: https://models.physiomeproject.org/workspace/b44
"""
...
class CellmlBertramEtAl2011LymphangionModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Bertram et al. (2011) Lymphangion Model."""

    def __init__(self, model_path: str = "data/Bertram_2011.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BertramEtAl2011LymphangionModelB44Model = CellmlBertramEtAl2011LymphangionModel
