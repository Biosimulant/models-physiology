...
"""Auto-generated CellML BioModule wrapper for Mckenzie, Sneyd, 1998.

Source: physiome:mckenzie_sneyd_1998
Original: https://models.physiomeproject.org/workspace/mckenzie_sneyd_1998
"""
...
class CellmlMckenzieSneyd1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Mckenzie, Sneyd, 1998."""

    def __init__(self, model_path: str = "data/mckenzie_sneyd_1998.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MckenzieSneyd1998Mckenziesneyd1998Model = CellmlMckenzieSneyd1998
