...
"""Auto-generated CellML BioModule wrapper for Chen, Popel, 2007.

Source: physiome:chen_popel_2007
Original: https://models.physiomeproject.org/workspace/chen_popel_2007
"""
...
class CellmlChenPopel2007(biosim.BioModule):
    """BioModule wrapper for CellML model: Chen, Popel, 2007."""

    def __init__(self, model_path: str = "data/chen_popel_2007_b.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChenPopel2007Chenpopel2007Model = CellmlChenPopel2007
