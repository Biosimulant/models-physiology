...
**Source**: [physiome](https://models.physiomeproject.org/workspace/633)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-voigt-heijman-et-al-2013-human-atrial-ap-model-633-model/model.yaml
```
