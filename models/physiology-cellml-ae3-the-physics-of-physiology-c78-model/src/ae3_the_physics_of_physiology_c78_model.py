...
"""Auto-generated CellML BioModule wrapper for AE3 - The Physics of Physiology.

Source: physiome:c78
Original: https://models.physiomeproject.org/workspace/c78
"""
...
class CellmlAe3ThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: AE3 - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_AE3.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ae3ThePhysicsOfPhysiologyC78Model = CellmlAe3ThePhysicsOfPhysiology
