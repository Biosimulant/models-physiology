...
"""Auto-generated CellML BioModule wrapper for Swat, Kel and Herzel 2004.

Source: physiome:swat_kel_herzel_2004
Original: https://models.physiomeproject.org/workspace/swat_kel_herzel_2004
"""
...
class CellmlSwatKelAndHerzel2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Swat, Kel and Herzel 2004."""

    def __init__(self, model_path: str = "data/swat_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SwatKelAndHerzel2004Swatkelherzel2004Model = CellmlSwatKelAndHerzel2004
