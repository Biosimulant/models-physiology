...
"""Auto-generated CellML BioModule wrapper for Guyton, Angiotensin, 2008.

Source: physiome:guyton_angiotensin_2008
Original: https://models.physiomeproject.org/workspace/guyton_angiotensin_2008
"""
...
class CellmlGuytonAngiotensin2008(biosim.BioModule):
    """BioModule wrapper for CellML model: Guyton, Angiotensin, 2008."""

    def __init__(self, model_path: str = "data/angiotensin.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GuytonAngiotensin2008Guytonangiotensin2008Model = CellmlGuytonAngiotensin2008
