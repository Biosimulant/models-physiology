...
"""Auto-generated CellML BioModule wrapper for FCU_adenylylCyclase.

Source: physiome:705
Original: https://models.physiomeproject.org/workspace/705
"""
...
class CellmlFcuAdenylylcyclase(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_adenylylCyclase."""

    def __init__(self, model_path: str = "data/FCU_adenylylCyclase.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuAdenylylcyclase705Model = CellmlFcuAdenylylcyclase
