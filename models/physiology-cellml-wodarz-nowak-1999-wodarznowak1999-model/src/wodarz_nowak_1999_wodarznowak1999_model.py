...
"""Auto-generated CellML BioModule wrapper for Wodarz, Nowak, 1999.

Source: physiome:wodarz_nowak_1999
Original: https://models.physiomeproject.org/workspace/wodarz_nowak_1999
"""
...
class CellmlWodarzNowak1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Wodarz, Nowak, 1999."""

    def __init__(self, model_path: str = "data/wodarz_nowak_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WodarzNowak1999Wodarznowak1999Model = CellmlWodarzNowak1999
