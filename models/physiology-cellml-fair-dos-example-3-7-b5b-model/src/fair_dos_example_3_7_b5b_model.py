...
"""Auto-generated CellML BioModule wrapper for FAIR DOs example 3.7.

Source: physiome:b5b
Original: https://models.physiomeproject.org/workspace/b5b
"""
...
class CellmlFairDosExample37(biosim.BioModule):
    """BioModule wrapper for CellML model: FAIR DOs example 3.7."""

    def __init__(self, model_path: str = "data/FAIRDO_BG_example_3.7.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FairDosExample37B5bModel = CellmlFairDosExample37
