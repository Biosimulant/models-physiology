...
"""Auto-generated CellML BioModule wrapper for Acid-Base Physiology.

Source: physiome:297
Original: https://models.physiomeproject.org/workspace/297
"""
...
class CellmlAcidBasePhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: Acid-Base Physiology."""

    def __init__(self, model_path: str = "data/acid_base.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AcidBasePhysiology297Model = CellmlAcidBasePhysiology
