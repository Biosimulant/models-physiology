...
"""Auto-generated CellML BioModule wrapper for Magnus, Keizer, 1997.

Source: physiome:magnus_keizer_1997
Original: https://models.physiomeproject.org/workspace/magnus_keizer_1997
"""
...
class CellmlMagnusKeizer1997(biosim.BioModule):
    """BioModule wrapper for CellML model: Magnus, Keizer, 1997."""

    def __init__(self, model_path: str = "data/magnus_keizer_1997.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MagnusKeizer1997Magnuskeizer1997Model = CellmlMagnusKeizer1997
