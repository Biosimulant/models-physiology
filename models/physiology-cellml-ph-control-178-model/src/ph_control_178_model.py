...
"""Auto-generated CellML BioModule wrapper for pH control.

Source: physiome:178
Original: https://models.physiomeproject.org/workspace/178
"""
...
class CellmlPhControl(biosim.BioModule):
    """BioModule wrapper for CellML model: pH control."""

    def __init__(self, model_path: str = "data/PhysicalConstants.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PhControl178Model = CellmlPhControl
