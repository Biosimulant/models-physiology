...
"""Auto-generated CellML BioModule wrapper for Weinstein 2000.

Source: physiome:weinstein_2000
Original: https://models.physiomeproject.org/workspace/weinstein_2000
"""
...
class CellmlWeinstein2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Weinstein 2000."""

    def __init__(self, model_path: str = "data/Weinstein_2000_AE1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Weinstein2000Weinstein2000Model = CellmlWeinstein2000
