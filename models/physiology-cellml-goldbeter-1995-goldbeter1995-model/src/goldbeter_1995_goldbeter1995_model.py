...
"""Auto-generated CellML BioModule wrapper for Goldbeter, 1995.

Source: physiome:goldbeter_1995
Original: https://models.physiomeproject.org/workspace/goldbeter_1995
"""
...
class CellmlGoldbeter1995(biosim.BioModule):
    """BioModule wrapper for CellML model: Goldbeter, 1995."""

    def __init__(self, model_path: str = "data/goldbeter_1995.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter1995Goldbeter1995Model = CellmlGoldbeter1995
