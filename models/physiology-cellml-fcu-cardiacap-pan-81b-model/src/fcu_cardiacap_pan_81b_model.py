...
"""Auto-generated CellML BioModule wrapper for FCU_cardiacAP_Pan.

Source: physiome:81b
Original: https://models.physiomeproject.org/workspace/81b
"""
...
class CellmlFcuCardiacapPan(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_cardiacAP_Pan."""

    def __init__(self, model_path: str = "data/FCU_cardiacAP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuCardiacapPan81bModel = CellmlFcuCardiacapPan
