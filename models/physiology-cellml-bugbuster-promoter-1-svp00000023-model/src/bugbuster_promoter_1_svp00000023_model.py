...
"""Auto-generated CellML BioModule wrapper for Bugbuster Promoter 1.

Source: physiome:SVP_00000023
Original: https://models.physiomeproject.org/workspace/SVP_00000023
"""
...
class CellmlBugbusterPromoter1(biosim.BioModule):
    """BioModule wrapper for CellML model: Bugbuster Promoter 1."""

    def __init__(self, model_path: str = "data/Bugbuster_Promoter1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BugbusterPromoter1Svp00000023Model = CellmlBugbusterPromoter1
