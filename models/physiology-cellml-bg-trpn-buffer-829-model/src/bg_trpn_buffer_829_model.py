...
"""Auto-generated CellML BioModule wrapper for BG_TRPN_buffer.

Source: physiome:829
Original: https://models.physiomeproject.org/workspace/829
"""
...
class CellmlBgTrpnBuffer(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_TRPN_buffer."""

    def __init__(self, model_path: str = "data/BG_TRPN_buffer.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgTrpnBuffer829Model = CellmlBgTrpnBuffer
