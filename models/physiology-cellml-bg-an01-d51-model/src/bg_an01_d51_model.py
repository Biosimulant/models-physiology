...
"""Auto-generated CellML BioModule wrapper for BG_An01.

Source: physiome:d51
Original: https://models.physiomeproject.org/workspace/d51
"""
...
class CellmlBgAn01(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_An01."""

    def __init__(self, model_path: str = "data/BG_An01.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
