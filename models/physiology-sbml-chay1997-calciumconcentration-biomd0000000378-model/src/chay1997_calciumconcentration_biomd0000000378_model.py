...
"""Auto-generated SBML BioModule wrapper for Chay1997_CalciumConcentration.

Source: biomodels_ebi:BIOMD0000000378
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000378
"""
...
class SbmlChay1997Calciumconcentration(biosim.BioModule):
    """BioModule wrapper for SBML model: Chay1997_CalciumConcentration."""

    def __init__(self, model_path: str = "data/BIOMD0000000378.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chay1997CalciumconcentrationBiomd0000000378Model = SbmlChay1997Calciumconcentration
