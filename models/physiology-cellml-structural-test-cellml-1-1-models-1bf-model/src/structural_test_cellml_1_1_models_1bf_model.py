...
"""Auto-generated CellML BioModule wrapper for Structural Test CellML 1.1 Models.

Source: physiome:1bf
Original: https://models.physiomeproject.org/workspace/1bf
"""
...
class CellmlStructuralTestCellml11Models(biosim.BioModule):
    """BioModule wrapper for CellML model: Structural Test CellML 1.1 Models."""

    def __init__(self, model_path: str = "data/1-S_equals_1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
StructuralTestCellml11Models1bfModel = CellmlStructuralTestCellml11Models
