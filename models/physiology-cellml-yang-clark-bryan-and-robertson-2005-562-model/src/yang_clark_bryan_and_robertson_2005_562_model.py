...
"""Auto-generated CellML BioModule wrapper for Yang, Clark, Bryan and Robertson 2005.

Source: physiome:562
Original: https://models.physiomeproject.org/workspace/562
"""
...
class CellmlYangClarkBryanAndRobertson2005(biosim.BioModule):
    """BioModule wrapper for CellML model: Yang, Clark, Bryan and Robertson 2005."""

    def __init__(self, model_path: str = "data/yang_2005_FIg3ab.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
YangClarkBryanAndRobertson2005562Model = CellmlYangClarkBryanAndRobertson2005
