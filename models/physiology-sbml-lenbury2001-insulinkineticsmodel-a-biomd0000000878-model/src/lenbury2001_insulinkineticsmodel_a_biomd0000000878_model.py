...
"""Auto-generated SBML BioModule wrapper for Lenbury2001_InsulinKineticsModel_A.

Source: biomodels_ebi:BIOMD0000000878
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000878
"""
...
class SbmlLenbury2001InsulinkineticsmodelA(biosim.BioModule):
    """BioModule wrapper for SBML model: Lenbury2001_InsulinKineticsModel_A."""

    def __init__(self, model_path: str = "data/BIOMD0000000878.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lenbury2001InsulinkineticsmodelABiomd0000000878Model = SbmlLenbury2001InsulinkineticsmodelA
