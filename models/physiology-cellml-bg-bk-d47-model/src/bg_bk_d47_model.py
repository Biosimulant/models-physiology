...
"""Auto-generated CellML BioModule wrapper for BG_BK.

Source: physiome:d47
Original: https://models.physiomeproject.org/workspace/d47
"""
...
class CellmlBgBk(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_BK."""

    def __init__(self, model_path: str = "data/BG_BK.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
