...
"""Auto-generated CellML BioModule wrapper for BG_LRGbinding_M2.

Source: physiome:707
Original: https://models.physiomeproject.org/workspace/707
"""
...
class CellmlBgLrgbindingM2(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_LRGbinding_M2."""

    def __init__(self, model_path: str = "data/BG_LRGbinding_M2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgLrgbindingM2707Model = CellmlBgLrgbindingM2
