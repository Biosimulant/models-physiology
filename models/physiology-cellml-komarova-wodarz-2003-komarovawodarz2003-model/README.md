...
**Source**: [physiome](https://models.physiomeproject.org/workspace/komarova_wodarz_2003)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-komarova-wodarz-2003-komarovawodarz2003-model
    alias: model
```
