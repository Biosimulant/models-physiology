...
"""Auto-generated CellML BioModule wrapper for Simple Growth Model.

Source: physiome:27a
Original: https://models.physiomeproject.org/workspace/27a
"""
...
class CellmlSimpleGrowthModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Simple Growth Model."""

    def __init__(self, model_path: str = "data/mooneyrivlin.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SimpleGrowthModel27aModel = CellmlSimpleGrowthModel
