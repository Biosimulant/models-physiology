...
"""Auto-generated CellML BioModule wrapper for Sten2020-Neurovascular Coupling Model.

Source: physiome:8a2
Original: https://models.physiomeproject.org/workspace/8a2
"""
...
class CellmlSten2020NeurovascularCouplingModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Sten2020-Neurovascular Coupling Model."""

    def __init__(self, model_path: str = "data/sten2020_NVC_main.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sten2020NeurovascularCouplingModel8a2Model = CellmlSten2020NeurovascularCouplingModel
