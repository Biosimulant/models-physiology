...
"""Auto-generated CellML BioModule wrapper for BG_NMDA.

Source: physiome:d56
Original: https://models.physiomeproject.org/workspace/d56
"""
...
class CellmlBgNmda(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_NMDA."""

    def __init__(self, model_path: str = "data/BG_NMDA.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
