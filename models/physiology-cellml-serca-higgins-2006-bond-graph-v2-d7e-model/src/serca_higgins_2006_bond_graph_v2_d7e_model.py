...
"""Auto-generated CellML BioModule wrapper for SERCA Higgins, 2006 Bond Graph (v2).

Source: physiome:d7e
Original: https://models.physiomeproject.org/workspace/d7e
"""
...
class CellmlSercaHiggins2006BondGraphV2(biosim.BioModule):
    """BioModule wrapper for CellML model: SERCA Higgins, 2006 Bond Graph (v2)."""

    def __init__(self, model_path: str = "data/higgins2006_serca_wphosphate.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SercaHiggins2006BondGraphV2D7eModel = CellmlSercaHiggins2006BondGraphV2
