...
"""Auto-generated SBML BioModule wrapper for pancreas glucose model.

Source: biomodels_ebi:MODEL2401110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2401110001
"""
...
class SbmlPancreasGlucoseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: pancreas glucose model."""

    def __init__(self, model_path: str = "data/MODEL2401110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PancreasGlucoseModelModel2401110001Model = SbmlPancreasGlucoseModel
