...
"""Auto-generated CellML BioModule wrapper for Wolf, Heinrich, 2000.

Source: physiome:wolf_heinrich_2000
Original: https://models.physiomeproject.org/workspace/wolf_heinrich_2000
"""
...
class CellmlWolfHeinrich2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Wolf, Heinrich, 2000."""

    def __init__(self, model_path: str = "data/wolf_heinrich_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WolfHeinrich2000Wolfheinrich2000Model = CellmlWolfHeinrich2000
