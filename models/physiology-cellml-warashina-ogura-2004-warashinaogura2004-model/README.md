...
**Source**: [physiome](https://models.physiomeproject.org/workspace/warashina_ogura_2004)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-warashina-ogura-2004-warashinaogura2004-model
    alias: model
```
