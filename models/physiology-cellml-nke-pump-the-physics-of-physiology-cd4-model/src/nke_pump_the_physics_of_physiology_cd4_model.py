...
"""Auto-generated CellML BioModule wrapper for NKE pump - The Physics of Physiology.

Source: physiome:cd4
Original: https://models.physiomeproject.org/workspace/cd4
"""
...
class CellmlNkePumpThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: NKE pump - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/NKE_pump_BG_4states.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NkePumpThePhysicsOfPhysiologyCd4Model = CellmlNkePumpThePhysicsOfPhysiology
