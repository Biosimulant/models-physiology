...
"""Auto-generated CellML BioModule wrapper for BG_IPR.

Source: physiome:8ab
Original: https://models.physiomeproject.org/workspace/8ab
"""
...
class CellmlBgIpr(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_IPR."""

    def __init__(self, model_path: str = "data/BG_IPR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
