...
"""Auto-generated CellML BioModule wrapper for Earm, Noble, 1990.

Source: physiome:earm_noble_1990
Original: https://models.physiomeproject.org/workspace/earm_noble_1990
"""
...
class CellmlEarmNoble1990(biosim.BioModule):
    """BioModule wrapper for CellML model: Earm, Noble, 1990."""

    def __init__(self, model_path: str = "data/earm_noble_1990.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EarmNoble1990Earmnoble1990Model = CellmlEarmNoble1990
