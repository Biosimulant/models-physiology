...
"""Auto-generated CellML BioModule wrapper for Borghans 1997.

Source: physiome:borghans_1997
Original: https://models.physiomeproject.org/workspace/borghans_1997
"""
...
class CellmlBorghans1997(biosim.BioModule):
    """BioModule wrapper for CellML model: Borghans 1997."""

    def __init__(self, model_path: str = "data/borghans_dupont_goldbeter_1997a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Borghans1997Borghans1997Model = CellmlBorghans1997
