...
"""Auto-generated CellML BioModule wrapper for Iribe, Kohl, Noble, 2006.

Source: physiome:iribe_kohl_noble_2006
Original: https://models.physiomeproject.org/workspace/iribe_kohl_noble_2006
"""
...
class CellmlIribeKohlNoble2006(biosim.BioModule):
    """BioModule wrapper for CellML model: Iribe, Kohl, Noble, 2006."""

    def __init__(self, model_path: str = "data/iribe_kohl_noble_2006.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
IribeKohlNoble2006Iribekohlnoble2006Model = CellmlIribeKohlNoble2006
