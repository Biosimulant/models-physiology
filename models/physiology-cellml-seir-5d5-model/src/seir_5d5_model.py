...
"""Auto-generated CellML BioModule wrapper for SEIR.

Source: physiome:5d5
Original: https://models.physiomeproject.org/workspace/5d5
"""
...
class CellmlSeir2(biosim.BioModule):
    """BioModule wrapper for CellML model: SEIR."""

    def __init__(self, model_path: str = "data/COVIDSim.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
