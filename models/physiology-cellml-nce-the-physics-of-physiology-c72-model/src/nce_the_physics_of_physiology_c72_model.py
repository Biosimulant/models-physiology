...
"""Auto-generated CellML BioModule wrapper for NCE - The Physics of Physiology.

Source: physiome:c72
Original: https://models.physiomeproject.org/workspace/c72
"""
...
class CellmlNceThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: NCE - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_NCE.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NceThePhysicsOfPhysiologyC72Model = CellmlNceThePhysicsOfPhysiology
