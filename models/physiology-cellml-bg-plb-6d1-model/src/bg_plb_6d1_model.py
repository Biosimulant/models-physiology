...
"""Auto-generated CellML BioModule wrapper for BG_PLB.

Source: physiome:6d1
Original: https://models.physiomeproject.org/workspace/6d1
"""
...
class CellmlBgPlb(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_PLB."""

    def __init__(self, model_path: str = "data/BG_PLB.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
