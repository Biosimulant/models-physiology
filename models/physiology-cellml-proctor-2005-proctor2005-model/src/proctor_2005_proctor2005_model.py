...
"""Auto-generated CellML BioModule wrapper for Proctor, 2005.

Source: physiome:proctor_2005
Original: https://models.physiomeproject.org/workspace/proctor_2005
"""
...
class CellmlProctor2005(biosim.BioModule):
    """BioModule wrapper for CellML model: Proctor, 2005."""

    def __init__(self, model_path: str = "data/proctor_soti_boys_gillespie_shanley_wilkinson_kirkwood_2005.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2005Proctor2005Model = CellmlProctor2005
