...
"""Auto-generated CellML BioModule wrapper for CaT protein knowledge page.

Source: physiome:bdb
Original: https://models.physiomeproject.org/workspace/bdb
"""
...
class CellmlCatProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: CaT protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_CaT.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CatProteinKnowledgePageBdbModel = CellmlCatProteinKnowledgePage
