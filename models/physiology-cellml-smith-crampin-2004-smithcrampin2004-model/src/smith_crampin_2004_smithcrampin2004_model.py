...
"""Auto-generated CellML BioModule wrapper for Smith, Crampin, 2004.

Source: physiome:smith_crampin_2004
Original: https://models.physiomeproject.org/workspace/smith_crampin_2004
"""
...
class CellmlSmithCrampin2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Smith, Crampin, 2004."""

    def __init__(self, model_path: str = "data/smith_crampin_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SmithCrampin2004Smithcrampin2004Model = CellmlSmithCrampin2004
