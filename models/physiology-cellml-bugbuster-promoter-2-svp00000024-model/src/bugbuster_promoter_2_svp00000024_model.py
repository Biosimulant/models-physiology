...
"""Auto-generated CellML BioModule wrapper for Bugbuster Promoter 2.

Source: physiome:SVP_00000024
Original: https://models.physiomeproject.org/workspace/SVP_00000024
"""
...
class CellmlBugbusterPromoter2(biosim.BioModule):
    """BioModule wrapper for CellML model: Bugbuster Promoter 2."""

    def __init__(self, model_path: str = "data/Bugbuster_Promoter2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BugbusterPromoter2Svp00000024Model = CellmlBugbusterPromoter2
