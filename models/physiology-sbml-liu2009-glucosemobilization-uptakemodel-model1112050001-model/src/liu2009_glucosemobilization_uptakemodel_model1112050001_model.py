...
"""Auto-generated SBML BioModule wrapper for Liu2009_GlucoseMobilization_UptakeModel.

Source: biomodels_ebi:MODEL1112050001
Original: https://www.ebi.ac.uk/biomodels/MODEL1112050001
"""
...
class SbmlLiu2009GlucosemobilizationUptakemodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2009_GlucoseMobilization_UptakeModel."""

    def __init__(self, model_path: str = "data/MODEL1112050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2009GlucosemobilizationUptakemodelModel1112050001Model = SbmlLiu2009GlucosemobilizationUptakemodel
