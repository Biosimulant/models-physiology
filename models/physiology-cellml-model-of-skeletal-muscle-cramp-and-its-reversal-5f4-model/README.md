...
**Source**: [physiome](https://models.physiomeproject.org/workspace/5f4)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-model-of-skeletal-muscle-cramp-and-its-reversal-5f4-model/model.yaml
```
