...
"""Auto-generated SBML BioModule wrapper for EDES1.0 Eindhoven Diabetes Simulator.

Source: biomodels_ebi:MODEL2403070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2403070001
"""
...
class SbmlEdes10EindhovenDiabetesSimulator(biosim.BioModule):
    """BioModule wrapper for SBML model: EDES1.0 Eindhoven Diabetes Simulator."""

    def __init__(self, model_path: str = "data/MODEL2403070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Edes10EindhovenDiabetesSimulatorModel2403070001Model = SbmlEdes10EindhovenDiabetesSimulator
