...
"""Auto-generated CellML BioModule wrapper for NDCBE - The Physics of Physiology.

Source: physiome:c93
Original: https://models.physiomeproject.org/workspace/c93
"""
...
class CellmlNdcbeThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: NDCBE - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_NDCBE.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NdcbeThePhysicsOfPhysiologyC93Model = CellmlNdcbeThePhysicsOfPhysiology
