...
"""Auto-generated CellML BioModule wrapper for Kraeutler_Logic_Models.

Source: physiome:7e8
Original: https://models.physiomeproject.org/workspace/7e8
"""
...
class CellmlKraeutlerLogicModels(biosim.BioModule):
    """BioModule wrapper for CellML model: Kraeutler_Logic_Models."""

    def __init__(self, model_path: str = "data/BG_KraeutlerToy.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KraeutlerLogicModels7e8Model = CellmlKraeutlerLogicModels
