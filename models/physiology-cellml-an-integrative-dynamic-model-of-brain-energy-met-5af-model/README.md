...
**Source**: [physiome](https://models.physiomeproject.org/workspace/5af)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-an-integrative-dynamic-model-of-brain-energy-met-5af-model
    alias: model
```
