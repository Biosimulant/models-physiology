...
"""Auto-generated CellML BioModule wrapper for Livshitz, Rudy, 2007.

Source: physiome:livshitz_rudy_2007
Original: https://models.physiomeproject.org/workspace/livshitz_rudy_2007
"""
...
class CellmlLivshitzRudy2007(biosim.BioModule):
    """BioModule wrapper for CellML model: Livshitz, Rudy, 2007."""

    def __init__(self, model_path: str = "data/livshitz_rudy_2007.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LivshitzRudy2007Livshitzrudy2007Model = CellmlLivshitzRudy2007
