...
**Source**: [physiome](https://models.physiomeproject.org/workspace/modularmassactionprimer)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-a-primer-on-modular-mass-action-modelling-with-c-modularmassactionprimer-model
    alias: model
```
