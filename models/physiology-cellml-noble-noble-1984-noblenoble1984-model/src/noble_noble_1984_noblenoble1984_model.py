...
"""Auto-generated CellML BioModule wrapper for Noble, Noble, 1984.

Source: physiome:noble_noble_1984
Original: https://models.physiomeproject.org/workspace/noble_noble_1984
"""
...
class CellmlNobleNoble1984(biosim.BioModule):
    """BioModule wrapper for CellML model: Noble, Noble, 1984."""

    def __init__(self, model_path: str = "data/noble_noble_1984.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NobleNoble1984Noblenoble1984Model = CellmlNobleNoble1984
