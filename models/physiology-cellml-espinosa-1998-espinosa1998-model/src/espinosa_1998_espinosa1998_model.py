...
"""Auto-generated CellML BioModule wrapper for Espinosa, 1998.

Source: physiome:espinosa_1998
Original: https://models.physiomeproject.org/workspace/espinosa_1998
"""
...
class CellmlEspinosa1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Espinosa, 1998."""

    def __init__(self, model_path: str = "data/espinosa_1998_hypertrophic.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Espinosa1998Espinosa1998Model = CellmlEspinosa1998
