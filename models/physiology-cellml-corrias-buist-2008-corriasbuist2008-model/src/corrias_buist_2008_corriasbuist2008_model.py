...
"""Auto-generated CellML BioModule wrapper for Corrias, Buist, 2008.

Source: physiome:corrias_buist_2008
Original: https://models.physiomeproject.org/workspace/corrias_buist_2008
"""
...
class CellmlCorriasBuist2008(biosim.BioModule):
    """BioModule wrapper for CellML model: Corrias, Buist, 2008."""

    def __init__(self, model_path: str = "data/corrias_buist_2008.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CorriasBuist2008Corriasbuist2008Model = CellmlCorriasBuist2008
