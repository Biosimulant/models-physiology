...
"""Auto-generated CellML BioModule wrapper for Morris and Lecar 1981.

Source: physiome:morris_lecar_1981
Original: https://models.physiomeproject.org/workspace/morris_lecar_1981
"""
...
class CellmlMorrisAndLecar1981(biosim.BioModule):
    """BioModule wrapper for CellML model: Morris and Lecar 1981."""

    def __init__(self, model_path: str = "data/morris_1981.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MorrisAndLecar1981Morrislecar1981Model = CellmlMorrisAndLecar1981
