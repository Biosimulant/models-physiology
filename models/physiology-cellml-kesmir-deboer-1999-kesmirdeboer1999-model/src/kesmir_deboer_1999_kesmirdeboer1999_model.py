...
"""Auto-generated CellML BioModule wrapper for Kesmir, Deboer, 1999.

Source: physiome:kesmir_deboer_1999
Original: https://models.physiomeproject.org/workspace/kesmir_deboer_1999
"""
...
class CellmlKesmirDeboer1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Kesmir, Deboer, 1999."""

    def __init__(self, model_path: str = "data/kesmir_deboer_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KesmirDeboer1999Kesmirdeboer1999Model = CellmlKesmirDeboer1999
