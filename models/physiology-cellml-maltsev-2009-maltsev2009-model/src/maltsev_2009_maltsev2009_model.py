...
"""Auto-generated CellML BioModule wrapper for Maltsev 2009.

Source: physiome:maltsev_2009
Original: https://models.physiomeproject.org/workspace/maltsev_2009
"""
...
class CellmlMaltsev2009(biosim.BioModule):
    """BioModule wrapper for CellML model: Maltsev 2009."""

    def __init__(self, model_path: str = "data/maltsev_2009_paper.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maltsev2009Maltsev2009Model = CellmlMaltsev2009
