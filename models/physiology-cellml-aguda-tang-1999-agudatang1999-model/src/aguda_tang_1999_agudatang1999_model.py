...
"""Auto-generated CellML BioModule wrapper for Aguda, Tang, 1999.

Source: physiome:aguda_tang_1999
Original: https://models.physiomeproject.org/workspace/aguda_tang_1999
"""
...
class CellmlAgudaTang1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Aguda, Tang, 1999."""

    def __init__(self, model_path: str = "data/aguda_tang_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AgudaTang1999Agudatang1999Model = CellmlAgudaTang1999
