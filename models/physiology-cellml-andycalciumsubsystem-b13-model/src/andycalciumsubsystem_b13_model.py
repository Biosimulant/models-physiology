...
"""Auto-generated CellML BioModule wrapper for AndyCalciumSubsystem.

Source: physiome:b13
Original: https://models.physiomeproject.org/workspace/b13
"""
...
class CellmlAndycalciumsubsystem(biosim.BioModule):
    """BioModule wrapper for CellML model: AndyCalciumSubsystem."""

    def __init__(self, model_path: str = "data/AndyBGCaSubsystem.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AndycalciumsubsystemB13Model = CellmlAndycalciumsubsystem
