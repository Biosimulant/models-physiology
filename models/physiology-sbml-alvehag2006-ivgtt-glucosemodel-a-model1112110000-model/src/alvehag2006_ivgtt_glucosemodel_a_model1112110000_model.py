...
"""Auto-generated SBML BioModule wrapper for Alvehag2006_IVGTT_GlucoseModel_A.

Source: biomodels_ebi:MODEL1112110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1112110000
"""
...
class SbmlAlvehag2006IvgttGlucosemodelA(biosim.BioModule):
    """BioModule wrapper for SBML model: Alvehag2006_IVGTT_GlucoseModel_A."""

    def __init__(self, model_path: str = "data/MODEL1112110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alvehag2006IvgttGlucosemodelAModel1112110000Model = SbmlAlvehag2006IvgttGlucosemodelA
