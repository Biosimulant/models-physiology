...
"""Auto-generated CellML BioModule wrapper for BG_to_channel.

Source: physiome:82e
Original: https://models.physiomeproject.org/workspace/82e
"""
...
class CellmlBgToChannel(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_to_channel."""

    def __init__(self, model_path: str = "data/BG_TO.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgToChannel82eModel = CellmlBgToChannel
