...
"""Auto-generated CellML BioModule wrapper for BG_K_ATP.

Source: physiome:83a
Original: https://models.physiomeproject.org/workspace/83a
"""
...
class CellmlBgKAtp(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_K_ATP."""
