...
"""Auto-generated SBML BioModule wrapper for Fridlyand2010_GlucoseSensitivity_B.

Source: biomodels_ebi:BIOMD0000000349
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000349
"""
...
class SbmlFridlyand2010GlucosesensitivityB(biosim.BioModule):
    """BioModule wrapper for SBML model: Fridlyand2010_GlucoseSensitivity_B."""

    def __init__(self, model_path: str = "data/BIOMD0000000349.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fridlyand2010GlucosesensitivityBBiomd0000000349Model = SbmlFridlyand2010GlucosesensitivityB
