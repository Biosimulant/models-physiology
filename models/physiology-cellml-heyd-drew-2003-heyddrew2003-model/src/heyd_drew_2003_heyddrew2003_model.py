...
"""Auto-generated CellML BioModule wrapper for Heyd, Drew, 2003.

Source: physiome:heyd_drew_2003
Original: https://models.physiomeproject.org/workspace/heyd_drew_2003
"""
...
class CellmlHeydDrew2003(biosim.BioModule):
    """BioModule wrapper for CellML model: Heyd, Drew, 2003."""

    def __init__(self, model_path: str = "data/heyd_drew_2003.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HeydDrew2003Heyddrew2003Model = CellmlHeydDrew2003
