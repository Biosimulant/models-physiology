...
"""Auto-generated CellML BioModule wrapper for FCU_guanylylCyclase.

Source: physiome:860
Original: https://models.physiomeproject.org/workspace/860
"""
...
class CellmlFcuGuanylylcyclase(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_guanylylCyclase."""

    def __init__(self, model_path: str = "data/FCU_guanylylCyclase.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuGuanylylcyclase860Model = CellmlFcuGuanylylcyclase
