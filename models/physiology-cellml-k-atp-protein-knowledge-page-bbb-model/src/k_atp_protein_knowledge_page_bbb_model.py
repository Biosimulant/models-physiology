...
"""Auto-generated CellML BioModule wrapper for K ATP protein knowledge page.

Source: physiome:bbb
Original: https://models.physiomeproject.org/workspace/bbb
"""
...
class CellmlKAtpProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: K ATP protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_K_ATP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KAtpProteinKnowledgePageBbbModel = CellmlKAtpProteinKnowledgePage
