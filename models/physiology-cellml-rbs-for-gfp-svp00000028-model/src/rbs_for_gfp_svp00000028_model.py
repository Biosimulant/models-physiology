...
"""Auto-generated CellML BioModule wrapper for RBS for GFP.

Source: physiome:SVP_00000028
Original: https://models.physiomeproject.org/workspace/SVP_00000028
"""
...
class CellmlRbsForGfp(biosim.BioModule):
    """BioModule wrapper for CellML model: RBS for GFP."""

    def __init__(self, model_path: str = "data/Bugbuster_RBS_GFP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RbsForGfpSvp00000028Model = CellmlRbsForGfp
