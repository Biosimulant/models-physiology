...
"""Auto-generated CellML BioModule wrapper for Protein CDS for PhzM.

Source: physiome:SVP_00000040
Original: https://models.physiomeproject.org/workspace/SVP_00000040
"""
...
class CellmlProteinCdsForPhzm(biosim.BioModule):
    """BioModule wrapper for CellML model: Protein CDS for PhzM."""

    def __init__(self, model_path: str = "data/ElectrEcoBluDevice2_ProteinCDS_PhzM.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ProteinCdsForPhzmSvp00000040Model = CellmlProteinCdsForPhzm
