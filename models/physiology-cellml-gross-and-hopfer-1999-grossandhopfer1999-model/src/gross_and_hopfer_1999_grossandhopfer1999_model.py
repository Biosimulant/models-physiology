...
"""Auto-generated CellML BioModule wrapper for Gross and Hopfer, 1999.

Source: physiome:gross_and_hopfer_1999
Original: https://models.physiomeproject.org/workspace/gross_and_hopfer_1999
"""
...
class CellmlGrossAndHopfer1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Gross and Hopfer, 1999."""

    def __init__(self, model_path: str = "data/gross_and_hopfer_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GrossAndHopfer1999Grossandhopfer1999Model = CellmlGrossAndHopfer1999
