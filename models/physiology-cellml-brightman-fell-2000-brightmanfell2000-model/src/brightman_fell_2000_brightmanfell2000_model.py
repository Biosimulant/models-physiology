...
"""Auto-generated CellML BioModule wrapper for Brightman, Fell, 2000.

Source: physiome:brightman_fell_2000
Original: https://models.physiomeproject.org/workspace/brightman_fell_2000
"""
...
class CellmlBrightmanFell2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Brightman, Fell, 2000."""

    def __init__(self, model_path: str = "data/brightman_fell_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BrightmanFell2000Brightmanfell2000Model = CellmlBrightmanFell2000
