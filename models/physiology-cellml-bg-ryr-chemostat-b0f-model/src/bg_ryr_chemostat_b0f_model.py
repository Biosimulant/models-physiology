...
"""Auto-generated CellML BioModule wrapper for BG_RyR_chemostat.

Source: physiome:b0f
Original: https://models.physiomeproject.org/workspace/b0f
"""
...
class CellmlBgRyrChemostat(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_RyR_chemostat."""

    def __init__(self, model_path: str = "data/BG_RyR_chemostat.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgRyrChemostatB0fModel = CellmlBgRyrChemostat
