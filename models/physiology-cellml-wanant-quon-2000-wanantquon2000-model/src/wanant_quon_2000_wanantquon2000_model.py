...
"""Auto-generated CellML BioModule wrapper for Wanant, Quon, 2000.

Source: physiome:wanant_quon_2000
Original: https://models.physiomeproject.org/workspace/wanant_quon_2000
"""
...
class CellmlWanantQuon2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Wanant, Quon, 2000."""

    def __init__(self, model_path: str = "data/wanant_quon_2000_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WanantQuon2000Wanantquon2000Model = CellmlWanantQuon2000
