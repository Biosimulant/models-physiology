...
"""Auto-generated CellML BioModule wrapper for Gerstner,Kistler,2002.

Source: physiome:694
Original: https://models.physiomeproject.org/workspace/694
"""
...
class CellmlGerstnerKistler2002(biosim.BioModule):
    """BioModule wrapper for CellML model: Gerstner,Kistler,2002."""

    def __init__(self, model_path: str = "data/gerstner_kistler_model_2002.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GerstnerKistler2002694Model = CellmlGerstnerKistler2002
