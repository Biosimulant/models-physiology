...
"""Auto-generated CellML BioModule wrapper for Shorten, Wall, 2000.

Source: physiome:shorten_wall_2000
Original: https://models.physiomeproject.org/workspace/shorten_wall_2000
"""
...
class CellmlShortenWall2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Shorten, Wall, 2000."""

    def __init__(self, model_path: str = "data/shorten_wall_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ShortenWall2000Shortenwall2000Model = CellmlShortenWall2000
