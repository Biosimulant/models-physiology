...
"""Auto-generated SBML BioModule wrapper for Berzins2022 - Crypthecodinium cohnii: ethanol uptake for production of DHA precursor acetyl-CoA.

Source: biomodels_ebi:MODEL2112290001
Original: https://www.ebi.ac.uk/biomodels/MODEL2112290001
"""
...
class SbmlBerzins2022CrypthecodiniumCohniiEthanolUptakeFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Berzins2022 - Crypthecodinium cohnii: ethanol uptake for production of DHA precursor acetyl-CoA."""

    def __init__(self, model_path: str = "data/MODEL2112290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Berzins2022CrypthecodiniumCohniiEthanolUptakModel2112290001Model = SbmlBerzins2022CrypthecodiniumCohniiEthanolUptakeFor
