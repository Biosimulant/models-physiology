...
"""Auto-generated CellML BioModule wrapper for Signalling Principled Model Example.

Source: physiome:2c4
Original: https://models.physiomeproject.org/workspace/2c4
"""
...
class CellmlSignallingPrincipledModelExample(biosim.BioModule):
    """BioModule wrapper for CellML model: Signalling Principled Model Example."""

    def __init__(self, model_path: str = "data/ASignallingExample.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SignallingPrincipledModelExample2c4Model = CellmlSignallingPrincipledModelExample
