...
"""Auto-generated CellML BioModule wrapper for Wang, Li, Kuang, 2007.

Source: physiome:wang_li_kuang_2007
Original: https://models.physiomeproject.org/workspace/wang_li_kuang_2007
"""
...
class CellmlWangLiKuang2007(biosim.BioModule):
    """BioModule wrapper for CellML model: Wang, Li, Kuang, 2007."""

    def __init__(self, model_path: str = "data/wang_li_kuang_2007.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WangLiKuang2007Wanglikuang2007Model = CellmlWangLiKuang2007
