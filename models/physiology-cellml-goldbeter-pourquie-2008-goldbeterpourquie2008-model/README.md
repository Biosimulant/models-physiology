...
**Source**: [physiome](https://models.physiomeproject.org/workspace/goldbeter_pourquie_2008)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-goldbeter-pourquie-2008-goldbeterpourquie2008-model
    alias: model
```
