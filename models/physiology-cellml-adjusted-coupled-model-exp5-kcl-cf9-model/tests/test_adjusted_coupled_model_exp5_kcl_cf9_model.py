...
"""Auto-generated tests for AdjustedCoupledModelExp5KclCf9Model.
...
from src.adjusted_coupled_model_exp5_kcl_cf9_model import AdjustedCoupledModelExp5KclCf9Model  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = AdjustedCoupledModelExp5KclCf9Model()
...
def test_advance_produces_outputs() -> None:
    module = AdjustedCoupledModelExp5KclCf9Model(min_dt=0.1)
