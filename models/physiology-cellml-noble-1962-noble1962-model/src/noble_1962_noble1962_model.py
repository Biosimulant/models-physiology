...
"""Auto-generated CellML BioModule wrapper for Noble, 1962.

Source: physiome:noble_1962
Original: https://models.physiomeproject.org/workspace/noble_1962
"""
...
class CellmlNoble1962(biosim.BioModule):
    """BioModule wrapper for CellML model: Noble, 1962."""

    def __init__(self, model_path: str = "data/noble_1962.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Noble1962Noble1962Model = CellmlNoble1962
