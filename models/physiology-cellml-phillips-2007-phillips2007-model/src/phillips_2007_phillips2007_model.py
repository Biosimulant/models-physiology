...
"""Auto-generated CellML BioModule wrapper for Phillips 2007.

Source: physiome:phillips_2007
Original: https://models.physiomeproject.org/workspace/phillips_2007
"""
...
class CellmlPhillips20072(biosim.BioModule):
    """BioModule wrapper for CellML model: Phillips 2007."""

    def __init__(self, model_path: str = "data/phillips_2007.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Phillips2007Phillips2007Model = CellmlPhillips20072
