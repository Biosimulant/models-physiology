...
"""Auto-generated CellML BioModule wrapper for CFTR.

Source: physiome:4c0
Original: https://models.physiomeproject.org/workspace/4c0
"""
...
class CellmlCftr(biosim.BioModule):
    """BioModule wrapper for CellML model: CFTR."""

    def __init__(self, model_path: str = "data/CFTR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
