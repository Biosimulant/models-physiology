...
"""Auto-generated CellML BioModule wrapper for ElectrEcoBlu Promoter 1.

Source: physiome:SVP_00000033
Original: https://models.physiomeproject.org/workspace/SVP_00000033
"""
...
class CellmlElectrecobluPromoter1(biosim.BioModule):
    """BioModule wrapper for CellML model: ElectrEcoBlu Promoter 1."""

    def __init__(self, model_path: str = "data/ElectrEcoBluDevice1_Promoter.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ElectrecobluPromoter1Svp00000033Model = CellmlElectrecobluPromoter1
