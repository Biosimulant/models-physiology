...
"""Auto-generated CellML BioModule wrapper for Iancu 2007.

Source: physiome:iancu_2007
Original: https://models.physiomeproject.org/workspace/iancu_2007
"""
...
class CellmlIancu2007(biosim.BioModule):
    """BioModule wrapper for CellML model: Iancu 2007."""

    def __init__(self, model_path: str = "data/iancu_jones_harvey_2007.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iancu2007Iancu2007Model = CellmlIancu2007
