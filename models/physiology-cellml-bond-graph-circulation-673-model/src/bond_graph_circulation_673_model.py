...
"""Auto-generated CellML BioModule wrapper for Bond Graph Circulation.

Source: physiome:673
Original: https://models.physiomeproject.org/workspace/673
"""
...
class CellmlBondGraphCirculation2(biosim.BioModule):
    """BioModule wrapper for CellML model: Bond Graph Circulation."""

    def __init__(self, model_path: str = "data/BG_Modules.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BondGraphCirculation673Model = CellmlBondGraphCirculation2
