...
"""Auto-generated CellML BioModule wrapper for Wu, Jeneson, Beard, 2006.

Source: physiome:wu_jeneson_beard_2006
Original: https://models.physiomeproject.org/workspace/wu_jeneson_beard_2006
"""
...
class CellmlWuJenesonBeard20062(biosim.BioModule):
    """BioModule wrapper for CellML model: Wu, Jeneson, Beard, 2006."""

    def __init__(self, model_path: str = "data/wu_jeneson_beard_2006.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WuJenesonBeard2006Wujenesonbeard2006Model = CellmlWuJenesonBeard20062
