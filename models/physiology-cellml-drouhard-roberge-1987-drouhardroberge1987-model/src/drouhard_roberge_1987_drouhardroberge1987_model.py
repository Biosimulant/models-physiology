...
"""Auto-generated CellML BioModule wrapper for Drouhard, Roberge, 1987.

Source: physiome:drouhard_roberge_1987
Original: https://models.physiomeproject.org/workspace/drouhard_roberge_1987
"""
...
class CellmlDrouhardRoberge1987(biosim.BioModule):
    """BioModule wrapper for CellML model: Drouhard, Roberge, 1987."""

    def __init__(self, model_path: str = "data/drouhard_roberge_1987.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DrouhardRoberge1987Drouhardroberge1987Model = CellmlDrouhardRoberge1987
