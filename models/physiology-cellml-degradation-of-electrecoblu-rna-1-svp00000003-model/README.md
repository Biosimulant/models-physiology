...
**Source**: [physiome](https://models.physiomeproject.org/workspace/SVP_00000003)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-degradation-of-electrecoblu-rna-1-svp00000003-model
    alias: model
```
