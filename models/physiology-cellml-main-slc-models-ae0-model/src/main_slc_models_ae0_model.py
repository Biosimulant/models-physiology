...
"""Auto-generated CellML BioModule wrapper for Main SLC Models.

Source: physiome:ae0
Original: https://models.physiomeproject.org/workspace/ae0
"""
...
class CellmlMainSlcModels(biosim.BioModule):
    """BioModule wrapper for CellML model: Main SLC Models."""

    def __init__(self, model_path: str = "data/Transporter_1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MainSlcModelsAe0Model = CellmlMainSlcModels
