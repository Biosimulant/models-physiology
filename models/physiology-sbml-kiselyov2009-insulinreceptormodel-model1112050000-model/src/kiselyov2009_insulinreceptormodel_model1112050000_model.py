...
"""Auto-generated SBML BioModule wrapper for Kiselyov2009_InsulinReceptorModel.

Source: biomodels_ebi:MODEL1112050000
Original: https://www.ebi.ac.uk/biomodels/MODEL1112050000
"""
...
class SbmlKiselyov2009Insulinreceptormodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Kiselyov2009_InsulinReceptorModel."""

    def __init__(self, model_path: str = "data/MODEL1112050000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kiselyov2009InsulinreceptormodelModel1112050000Model = SbmlKiselyov2009Insulinreceptormodel
