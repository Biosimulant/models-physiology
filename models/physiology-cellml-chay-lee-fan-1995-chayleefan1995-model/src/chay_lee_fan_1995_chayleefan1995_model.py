...
"""Auto-generated CellML BioModule wrapper for Chay, Lee, Fan, 1995.

Source: physiome:chay_lee_fan_1995
Original: https://models.physiomeproject.org/workspace/chay_lee_fan_1995
"""
...
class CellmlChayLeeFan1995(biosim.BioModule):
    """BioModule wrapper for CellML model: Chay, Lee, Fan, 1995."""

    def __init__(self, model_path: str = "data/chay_lee_fan_1995.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChayLeeFan1995Chayleefan1995Model = CellmlChayLeeFan1995
