...
"""Auto-generated CellML BioModule wrapper for NKE knowledge page.

Source: physiome:b9a
Original: https://models.physiomeproject.org/workspace/b9a
"""
...
class CellmlNkeKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: NKE knowledge page."""

    def __init__(self, model_path: str = "data/BG_NaK.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NkeKnowledgePageB9aModel = CellmlNkeKnowledgePage
