...
"""Auto-generated CellML BioModule wrapper for BG_K1.

Source: physiome:824
Original: https://models.physiomeproject.org/workspace/824
"""
...
class CellmlBgK1(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_K1."""

    def __init__(self, model_path: str = "data/BG_K1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
