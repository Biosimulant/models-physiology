...
"""Auto-generated CellML BioModule wrapper for BG Units.

Source: physiome:c79
Original: https://models.physiomeproject.org/workspace/c79
"""
...
class CellmlBgUnits(biosim.BioModule):
    """BioModule wrapper for CellML model: BG Units."""

    def __init__(self, model_path: str = "data/constants.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
