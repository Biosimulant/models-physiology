...
"""Auto-generated CellML BioModule wrapper for Kroll, 2000.

Source: physiome:kroll_2000
Original: https://models.physiomeproject.org/workspace/kroll_2000
"""
...
class CellmlKroll2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Kroll, 2000."""

    def __init__(self, model_path: str = "data/kroll_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kroll2000Kroll2000Model = CellmlKroll2000
