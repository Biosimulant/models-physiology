...
"""Auto-generated CellML BioModule wrapper for Tyson, 1991.

Source: physiome:tyson_1991
Original: https://models.physiomeproject.org/workspace/tyson_1991
"""
...
class CellmlTyson1991(biosim.BioModule):
    """BioModule wrapper for CellML model: Tyson, 1991."""

    def __init__(self, model_path: str = "data/tyson_1991.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson1991Tyson1991Model = CellmlTyson1991
