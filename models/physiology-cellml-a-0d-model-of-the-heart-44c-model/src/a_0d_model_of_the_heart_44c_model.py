...
"""Auto-generated CellML BioModule wrapper for A 0D model of the Heart.

Source: physiome:44c
Original: https://models.physiomeproject.org/workspace/44c
"""
...
class CellmlA0dModelOfTheHeart(biosim.BioModule):
    """BioModule wrapper for CellML model: A 0D model of the Heart."""

    def __init__(self, model_path: str = "data/HOD.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
A0dModelOfTheHeart44cModel = CellmlA0dModelOfTheHeart
