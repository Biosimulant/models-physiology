...
"""Auto-generated CellML BioModule wrapper for Wodarz, Hamer, 2007.

Source: physiome:wodarz_hamer_2007
Original: https://models.physiomeproject.org/workspace/wodarz_hamer_2007
"""
...
class CellmlWodarzHamer20072(biosim.BioModule):
    """BioModule wrapper for CellML model: Wodarz, Hamer, 2007."""

    def __init__(self, model_path: str = "data/wodarz_hamer_2007_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WodarzHamer2007Wodarzhamer2007Model = CellmlWodarzHamer20072
