...
"""Auto-generated CellML BioModule wrapper for Weak Acid Hydration.

Source: physiome:34d
Original: https://models.physiomeproject.org/workspace/34d
"""
...
class CellmlWeakAcidHydration(biosim.BioModule):
    """BioModule wrapper for CellML model: Weak Acid Hydration."""

    def __init__(self, model_path: str = "data/CO2_Hydration_module.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WeakAcidHydration34dModel = CellmlWeakAcidHydration
