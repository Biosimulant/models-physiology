...
**Source**: [physiome](https://models.physiomeproject.org/workspace/li_bertram_rinzel_1996)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-li-bertram-and-rinzel-1996-libertramrinzel1996-model
    alias: model
```
