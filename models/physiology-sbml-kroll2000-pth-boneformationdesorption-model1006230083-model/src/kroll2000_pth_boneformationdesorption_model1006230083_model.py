...
"""Auto-generated SBML BioModule wrapper for Kroll2000_PTH_BoneFormationDesorption.

Source: biomodels_ebi:MODEL1006230083
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230083
"""
...
class SbmlKroll2000PthBoneformationdesorption(biosim.BioModule):
    """BioModule wrapper for SBML model: Kroll2000_PTH_BoneFormationDesorption."""

    def __init__(self, model_path: str = "data/MODEL1006230083.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kroll2000PthBoneformationdesorptionModel1006230083Model = SbmlKroll2000PthBoneformationdesorption
