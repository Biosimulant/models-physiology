...
"""Auto-generated CellML BioModule wrapper for NBCe1 - The Physics of Physiology.

Source: physiome:c91
Original: https://models.physiomeproject.org/workspace/c91
"""
...
class CellmlNbce1ThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: NBCe1 - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_NBCe1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nbce1ThePhysicsOfPhysiologyC91Model = CellmlNbce1ThePhysicsOfPhysiology
