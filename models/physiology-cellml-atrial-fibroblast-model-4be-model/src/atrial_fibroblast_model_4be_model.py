...
"""Auto-generated CellML BioModule wrapper for Atrial fibroblast model.

Source: physiome:4be
Original: https://models.physiomeproject.org/workspace/4be
"""
...
class CellmlAtrialFibroblastModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Atrial fibroblast model."""

    def __init__(self, model_path: str = "data/Morgan_atrial_fibroblast_2016.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AtrialFibroblastModel4beModel = CellmlAtrialFibroblastModel
