...
**Source**: [physiome](https://models.physiomeproject.org/workspace/leloup_goldbeter_1998)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-leloup-goldbeter-1998-leloupgoldbeter1998-model
    alias: model
```
