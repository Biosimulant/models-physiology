...
"""Auto-generated SBML BioModule wrapper for Tolic2000_InsulinGlucoseFeedback.

Source: biomodels_ebi:BIOMD0000000372
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000372
"""
...
class SbmlTolic2000Insulinglucosefeedback(biosim.BioModule):
    """BioModule wrapper for SBML model: Tolic2000_InsulinGlucoseFeedback."""

    def __init__(self, model_path: str = "data/BIOMD0000000372.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tolic2000InsulinglucosefeedbackBiomd0000000372Model = SbmlTolic2000Insulinglucosefeedback
