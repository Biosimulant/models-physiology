...
**Source**: [physiome](https://models.physiomeproject.org/workspace/253)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-moss-kazmierczak-kirley-harris-2009-253-model/model.yaml
```
