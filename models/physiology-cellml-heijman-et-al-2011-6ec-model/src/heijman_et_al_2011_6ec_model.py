...
"""Auto-generated CellML BioModule wrapper for Heijman et al. 2011.

Source: physiome:6ec
Original: https://models.physiomeproject.org/workspace/6ec
"""
...
class CellmlHeijmanEtAl2011(biosim.BioModule):
    """BioModule wrapper for CellML model: Heijman et al. 2011."""

    def __init__(self, model_path: str = "data/heijman-2011.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HeijmanEtAl20116ecModel = CellmlHeijmanEtAl2011
