...
"""Auto-generated tests for BonhoefferRembiszewskiOrtizNixon20002dcModel.
...
from src.bonhoeffer_rembiszewski_ortiz_nixon_2000_2dc_model import BonhoefferRembiszewskiOrtizNixon20002dcModel  # noqa: E402
from biosim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = BonhoefferRembiszewskiOrtizNixon20002dcModel()
...
def test_advance_produces_outputs() -> None:
    module = BonhoefferRembiszewskiOrtizNixon20002dcModel(min_dt=0.1)
