...
"""Auto-generated CellML BioModule wrapper for BG_CaB.

Source: physiome:82a
Original: https://models.physiomeproject.org/workspace/82a
"""
...
class CellmlBgCab(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_CaB."""
