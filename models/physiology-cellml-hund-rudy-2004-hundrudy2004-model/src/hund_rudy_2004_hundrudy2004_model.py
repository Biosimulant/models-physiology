...
"""Auto-generated CellML BioModule wrapper for Hund, Rudy, 2004.

Source: physiome:hund_rudy_2004
Original: https://models.physiomeproject.org/workspace/hund_rudy_2004
"""
...
class CellmlHundRudy20042(biosim.BioModule):
    """BioModule wrapper for CellML model: Hund, Rudy, 2004."""

    def __init__(self, model_path: str = "data/hund_rudy_2004_a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HundRudy2004Hundrudy2004Model = CellmlHundRudy20042
