...
"""Auto-generated SBML BioModule wrapper for Shrestha2010_HyperCalcemia_PTHresponse.

Source: biomodels_ebi:BIOMD0000000277
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000277
"""
...
class SbmlShrestha2010HypercalcemiaPthresponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Shrestha2010_HyperCalcemia_PTHresponse."""

    def __init__(self, model_path: str = "data/BIOMD0000000277.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shrestha2010HypercalcemiaPthresponseBiomd0000000277Model = SbmlShrestha2010HypercalcemiaPthresponse
