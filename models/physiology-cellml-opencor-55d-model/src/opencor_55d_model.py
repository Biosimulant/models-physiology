...
"""Auto-generated CellML BioModule wrapper for OpenCOR.

Source: physiome:55d
Original: https://models.physiomeproject.org/workspace/55d
"""
...
class CellmlOpencor(biosim.BioModule):
    """BioModule wrapper for CellML model: OpenCOR."""

    def __init__(self, model_path: str = "data/hodgkin_huxley_squid_axon_model_1952.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
