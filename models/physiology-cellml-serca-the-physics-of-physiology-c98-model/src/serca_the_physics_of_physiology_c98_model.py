...
"""Auto-generated CellML BioModule wrapper for SERCA - The Physics of Physiology.

Source: physiome:c98
Original: https://models.physiomeproject.org/workspace/c98
"""
...
class CellmlSercaThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: SERCA - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_SERCA.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SercaThePhysicsOfPhysiologyC98Model = CellmlSercaThePhysicsOfPhysiology
