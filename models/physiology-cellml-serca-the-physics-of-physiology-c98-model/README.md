...
**Source**: [physiome](https://models.physiomeproject.org/workspace/c98)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-serca-the-physics-of-physiology-c98-model/model.yaml
```
