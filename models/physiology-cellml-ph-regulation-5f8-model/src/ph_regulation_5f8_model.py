...
"""Auto-generated CellML BioModule wrapper for pH Regulation.

Source: physiome:5f8
Original: https://models.physiomeproject.org/workspace/5f8
"""
...
class CellmlPhRegulation(biosim.BioModule):
    """BioModule wrapper for CellML model: pH Regulation."""

    def __init__(self, model_path: str = "data/Boron-CO2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PhRegulation5f8Model = CellmlPhRegulation
