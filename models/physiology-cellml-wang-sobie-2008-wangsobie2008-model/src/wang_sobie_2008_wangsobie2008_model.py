...
"""Auto-generated CellML BioModule wrapper for Wang, Sobie, 2008.

Source: physiome:wang_sobie_2008
Original: https://models.physiomeproject.org/workspace/wang_sobie_2008
"""
...
class CellmlWangSobie20082(biosim.BioModule):
    """BioModule wrapper for CellML model: Wang, Sobie, 2008."""

    def __init__(self, model_path: str = "data/wang_sobie_2008.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WangSobie2008Wangsobie2008Model = CellmlWangSobie20082
