...
"""Auto-generated CellML BioModule wrapper for RBS for PhzS.

Source: physiome:SVP_00000037
Original: https://models.physiomeproject.org/workspace/SVP_00000037
"""
...
class CellmlRbsForPhzs(biosim.BioModule):
    """BioModule wrapper for CellML model: RBS for PhzS."""

    def __init__(self, model_path: str = "data/ElectrEcoBluDevice2_RBS_PhzS.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RbsForPhzsSvp00000037Model = CellmlRbsForPhzs
