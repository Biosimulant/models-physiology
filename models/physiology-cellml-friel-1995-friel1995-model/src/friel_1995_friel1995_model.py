...
"""Auto-generated CellML BioModule wrapper for Friel, 1995.

Source: physiome:friel_1995
Original: https://models.physiomeproject.org/workspace/friel_1995
"""
...
class CellmlFriel19954(biosim.BioModule):
    """BioModule wrapper for CellML model: Friel, 1995."""

    def __init__(self, model_path: str = "data/friel_1995.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Friel1995Friel1995Model = CellmlFriel19954
