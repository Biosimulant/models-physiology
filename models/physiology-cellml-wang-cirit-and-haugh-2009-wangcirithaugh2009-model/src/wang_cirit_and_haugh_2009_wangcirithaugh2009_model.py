...
"""Auto-generated CellML BioModule wrapper for Wang, Cirit and Haugh 2009.

Source: physiome:wang_cirit_haugh_2009
Original: https://models.physiomeproject.org/workspace/wang_cirit_haugh_2009
"""
...
class CellmlWangCiritAndHaugh2009(biosim.BioModule):
    """BioModule wrapper for CellML model: Wang, Cirit and Haugh 2009."""

    def __init__(self, model_path: str = "data/wang_2009.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WangCiritAndHaugh2009Wangcirithaugh2009Model = CellmlWangCiritAndHaugh2009
