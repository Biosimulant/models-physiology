...
"""Auto-generated CellML BioModule wrapper for BG_Ca_leak.

Source: physiome:835
Original: https://models.physiomeproject.org/workspace/835
"""
...
class CellmlBgCaLeak(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_Ca_leak."""

    def __init__(self, model_path: str = "data/BG_Ca_leak.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgCaLeak835Model = CellmlBgCaLeak
