...
"""Auto-generated CellML BioModule wrapper for Demiray, 1981.

Source: physiome:demiray_1981
Original: https://models.physiomeproject.org/workspace/demiray_1981
"""
...
class CellmlDemiray1981(biosim.BioModule):
    """BioModule wrapper for CellML model: Demiray, 1981."""

    def __init__(self, model_path: str = "data/demiray_1981.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Demiray1981Demiray1981Model = CellmlDemiray1981
