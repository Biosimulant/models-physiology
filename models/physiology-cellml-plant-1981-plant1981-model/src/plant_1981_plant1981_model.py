...
"""Auto-generated CellML BioModule wrapper for Plant, 1981.

Source: physiome:plant_1981
Original: https://models.physiomeproject.org/workspace/plant_1981
"""
...
class CellmlPlant1981(biosim.BioModule):
    """BioModule wrapper for CellML model: Plant, 1981."""

    def __init__(self, model_path: str = "data/plant_1981.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Plant1981Plant1981Model = CellmlPlant1981
