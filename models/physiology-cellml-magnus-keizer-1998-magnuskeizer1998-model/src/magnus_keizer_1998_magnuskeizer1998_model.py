...
"""Auto-generated CellML BioModule wrapper for Magnus, Keizer, 1998.

Source: physiome:magnus_keizer_1998
Original: https://models.physiomeproject.org/workspace/magnus_keizer_1998
"""
...
class CellmlMagnusKeizer1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Magnus, Keizer, 1998."""

    def __init__(self, model_path: str = "data/magnus_keizer_1998.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MagnusKeizer1998Magnuskeizer1998Model = CellmlMagnusKeizer1998
