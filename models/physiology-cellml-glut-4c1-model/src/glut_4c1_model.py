...
"""Auto-generated CellML BioModule wrapper for GLUT.

Source: physiome:4c1
Original: https://models.physiomeproject.org/workspace/4c1
"""
...
class CellmlGlut(biosim.BioModule):
    """BioModule wrapper for CellML model: GLUT."""

    def __init__(self, model_path: str = "data/GLUT.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
