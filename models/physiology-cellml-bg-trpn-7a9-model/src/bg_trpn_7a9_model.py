...
"""Auto-generated CellML BioModule wrapper for BG_TRPN.

Source: physiome:7a9
Original: https://models.physiomeproject.org/workspace/7a9
"""
...
class CellmlBgTrpn(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_TRPN."""

    def __init__(self, model_path: str = "data/BG_TRPN.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
