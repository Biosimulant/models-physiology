...
"""Auto-generated CellML BioModule wrapper for Demir, Clark, Giles, 1999.

Source: physiome:demir_clark_giles_1999
Original: https://models.physiomeproject.org/workspace/demir_clark_giles_1999
"""
...
class CellmlDemirClarkGiles1999(biosim.BioModule):
    """BioModule wrapper for CellML model: Demir, Clark, Giles, 1999."""

    def __init__(self, model_path: str = "data/demir_clark_giles_1999.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DemirClarkGiles1999Demirclarkgiles1999Model = CellmlDemirClarkGiles1999
