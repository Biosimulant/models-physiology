...
"""Auto-generated CellML BioModule wrapper for PMCA knowledge page.

Source: physiome:baf
Original: https://models.physiomeproject.org/workspace/baf
"""
...
class CellmlPmcaKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: PMCA knowledge page."""

    def __init__(self, model_path: str = "data/BG_PMCA.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PmcaKnowledgePageBafModel = CellmlPmcaKnowledgePage
