...
"""Auto-generated CellML BioModule wrapper for BG_B1AR.

Source: physiome:6ba
Original: https://models.physiomeproject.org/workspace/6ba
"""
...
class CellmlBgB1ar(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_B1AR."""

    def __init__(self, model_path: str = "data/BG_B1AR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
