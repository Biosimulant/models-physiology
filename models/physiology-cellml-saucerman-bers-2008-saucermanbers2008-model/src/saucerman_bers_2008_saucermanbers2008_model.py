...
"""Auto-generated CellML BioModule wrapper for Saucerman, Bers, 2008.

Source: physiome:saucerman_bers_2008
Original: https://models.physiomeproject.org/workspace/saucerman_bers_2008
"""
...
class CellmlSaucermanBers2008(biosim.BioModule):
    """BioModule wrapper for CellML model: Saucerman, Bers, 2008."""

    def __init__(self, model_path: str = "data/saucerman_2008_cytosol.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SaucermanBers2008Saucermanbers2008Model = CellmlSaucermanBers2008
