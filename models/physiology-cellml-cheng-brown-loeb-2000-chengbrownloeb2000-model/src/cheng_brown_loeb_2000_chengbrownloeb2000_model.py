...
"""Auto-generated CellML BioModule wrapper for Cheng, Brown, Loeb, 2000.

Source: physiome:cheng_brown_loeb_2000
Original: https://models.physiomeproject.org/workspace/cheng_brown_loeb_2000
"""
...
class CellmlChengBrownLoeb2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Cheng, Brown, Loeb, 2000."""

    def __init__(self, model_path: str = "data/cheng_brown_loeb_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChengBrownLoeb2000Chengbrownloeb2000Model = CellmlChengBrownLoeb2000
