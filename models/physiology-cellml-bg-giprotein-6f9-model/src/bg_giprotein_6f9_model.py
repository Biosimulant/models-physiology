...
"""Auto-generated CellML BioModule wrapper for BG_GiProtein.

Source: physiome:6f9
Original: https://models.physiomeproject.org/workspace/6f9
"""
...
class CellmlBgGiprotein(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_GiProtein."""

    def __init__(self, model_path: str = "data/BG_GiProtein.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgGiprotein6f9Model = CellmlBgGiprotein
