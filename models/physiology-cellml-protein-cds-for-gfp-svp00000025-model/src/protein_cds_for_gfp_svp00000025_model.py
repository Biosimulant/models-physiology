...
"""Auto-generated CellML BioModule wrapper for Protein CDS for GFP.

Source: physiome:SVP_00000025
Original: https://models.physiomeproject.org/workspace/SVP_00000025
"""
...
class CellmlProteinCdsForGfp(biosim.BioModule):
    """BioModule wrapper for CellML model: Protein CDS for GFP."""

    def __init__(self, model_path: str = "data/Bugbuster_ProteinCDS_GFP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ProteinCdsForGfpSvp00000025Model = CellmlProteinCdsForGfp
