...
"""Auto-generated CellML BioModule wrapper for Heldt 2002.

Source: physiome:heldt_2002
Original: https://models.physiomeproject.org/workspace/heldt_2002
"""
...
class CellmlHeldt2002(biosim.BioModule):
    """BioModule wrapper for CellML model: Heldt 2002."""

    def __init__(self, model_path: str = "data/circ_pbpk.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2002Heldt2002Model = CellmlHeldt2002
