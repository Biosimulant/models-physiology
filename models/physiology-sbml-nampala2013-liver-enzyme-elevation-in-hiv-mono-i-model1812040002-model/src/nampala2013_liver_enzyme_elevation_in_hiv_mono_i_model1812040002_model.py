...
"""Auto-generated SBML BioModule wrapper for Nampala2013 - Liver enzyme elevation in HIV mono-infection.

Source: biomodels_ebi:MODEL1812040002
Original: https://www.ebi.ac.uk/biomodels/MODEL1812040002
"""
...
class SbmlNampala2013LiverEnzymeElevationInHivMonoInfection(biosim.BioModule):
    """BioModule wrapper for SBML model: Nampala2013 - Liver enzyme elevation in HIV mono-infection."""

    def __init__(self, model_path: str = "data/MODEL1812040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nampala2013LiverEnzymeElevationInHivMonoIModel1812040002Model = SbmlNampala2013LiverEnzymeElevationInHivMonoInfection
