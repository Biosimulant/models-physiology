...
"""Auto-generated CellML BioModule wrapper for Vancapelle, Durrer, 1980.

Source: physiome:vancapelle_durrer_1980
Original: https://models.physiomeproject.org/workspace/vancapelle_durrer_1980
"""
...
class CellmlVancapelleDurrer1980(biosim.BioModule):
    """BioModule wrapper for CellML model: Vancapelle, Durrer, 1980."""

    def __init__(self, model_path: str = "data/vancapelle_durrer_1980.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
VancapelleDurrer1980Vancapelledurrer1980Model = CellmlVancapelleDurrer1980
