...
"""Auto-generated CellML BioModule wrapper for Sine-Approximations.

Source: physiome:sine-approximations
Original: https://models.physiomeproject.org/workspace/sine-approximations
"""
...
class CellmlSineApproximations(biosim.BioModule):
    """BioModule wrapper for CellML model: Sine-Approximations."""

    def __init__(self, model_path: str = "data/sine-approximations.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SineApproximationsSineapproximationsModel = CellmlSineApproximations
