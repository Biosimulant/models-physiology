...
**Source**: [physiome](https://models.physiomeproject.org/workspace/af2)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-the-physics-of-physiology-example-6-an-enzyme-ca-af2-model
    alias: model
```
