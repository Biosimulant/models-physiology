...
"""Auto-generated tests for BugbusterStandardVirtualBiologicalMachineBugbusterModel.
...
from src.bugbuster_standard_virtual_biological_machine_bugbuster_model import BugbusterStandardVirtualBiologicalMachineBugbusterModel  # noqa: E402
from biosim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = BugbusterStandardVirtualBiologicalMachineBugbusterModel()
...
def test_advance_produces_outputs() -> None:
    module = BugbusterStandardVirtualBiologicalMachineBugbusterModel(min_dt=0.1)
