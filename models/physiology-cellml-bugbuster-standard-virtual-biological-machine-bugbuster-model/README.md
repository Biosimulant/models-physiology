...
**Source**: [physiome](https://models.physiomeproject.org/workspace/bugbuster)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-bugbuster-standard-virtual-biological-machine-bugbuster-model/model.yaml
```
