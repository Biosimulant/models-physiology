...
"""Auto-generated SBML BioModule wrapper for Keener2001_OscillatoryInsulinSecretionModel.

Source: biomodels_ebi:MODEL1201140001
Original: https://www.ebi.ac.uk/biomodels/MODEL1201140001
"""
...
class SbmlKeener2001Oscillatoryinsulinsecretionmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Keener2001_OscillatoryInsulinSecretionModel."""

    def __init__(self, model_path: str = "data/MODEL1201140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Keener2001OscillatoryinsulinsecretionmodelModel1201140001Model = SbmlKeener2001Oscillatoryinsulinsecretionmodel
