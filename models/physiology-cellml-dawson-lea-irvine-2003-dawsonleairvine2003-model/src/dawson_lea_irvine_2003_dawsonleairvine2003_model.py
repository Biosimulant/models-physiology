...
"""Auto-generated CellML BioModule wrapper for Dawson, Lea, Irvine, 2003.

Source: physiome:dawson_lea_irvine_2003
Original: https://models.physiomeproject.org/workspace/dawson_lea_irvine_2003
"""
...
class CellmlDawsonLeaIrvine2003(biosim.BioModule):
    """BioModule wrapper for CellML model: Dawson, Lea, Irvine, 2003."""

    def __init__(self, model_path: str = "data/dawson_lea_irvine_2003.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DawsonLeaIrvine2003Dawsonleairvine2003Model = CellmlDawsonLeaIrvine2003
