...
"""Auto-generated CellML BioModule wrapper for BG_CaL.

Source: physiome:6d7
Original: https://models.physiomeproject.org/workspace/6d7
"""
...
class CellmlBgCal(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_CaL."""

    def __init__(self, model_path: str = "data/BG_LCC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
