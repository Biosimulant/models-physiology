...
"""Auto-generated CellML BioModule wrapper for Degradation of IC.

Source: physiome:SVP_00000006
Original: https://models.physiomeproject.org/workspace/SVP_00000006
"""
...
class CellmlDegradationOfIc(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of IC."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_IC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfIcSvp00000006Model = CellmlDegradationOfIc
