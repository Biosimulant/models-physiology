...
**Source**: [physiome](https://models.physiomeproject.org/workspace/5e2)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-a-computational-human-ventricular-electrophysiol-5e2-model
    alias: model
```
