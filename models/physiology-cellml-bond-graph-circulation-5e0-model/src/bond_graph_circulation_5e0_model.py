...
Source: physiome:5e0
Original: https://models.physiomeproject.org/workspace/5e0
"""
...
class CellmlBondGraphCirculation(biosim.BioModule):
...
BondGraphCirculation5e0Model = CellmlBondGraphCirculation
