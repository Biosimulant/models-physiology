...
"""Auto-generated CellML BioModule wrapper for FCU_cardiac_pH.

Source: physiome:885
Original: https://models.physiomeproject.org/workspace/885
"""
...
class CellmlFcuCardiacPh(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_cardiac_pH."""

    def __init__(self, model_path: str = "data/FCU_cardiac_pH.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuCardiacPh885Model = CellmlFcuCardiacPh
