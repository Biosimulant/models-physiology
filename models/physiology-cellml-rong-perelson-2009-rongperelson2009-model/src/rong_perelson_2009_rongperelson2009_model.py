...
"""Auto-generated CellML BioModule wrapper for Rong, Perelson 2009.

Source: physiome:rong_perelson_2009
Original: https://models.physiomeproject.org/workspace/rong_perelson_2009
"""
...
class CellmlRongPerelson2009(biosim.BioModule):
    """BioModule wrapper for CellML model: Rong, Perelson 2009."""

    def __init__(self, model_path: str = "data/rong_2009a.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RongPerelson2009Rongperelson2009Model = CellmlRongPerelson2009
