...
"""Auto-generated CellML BioModule wrapper for Steady state HMT.

Source: physiome:4f0
Original: https://models.physiomeproject.org/workspace/4f0
"""
...
class CellmlSteadyStateHmt(biosim.BioModule):
    """BioModule wrapper for CellML model: Steady state HMT."""

    def __init__(self, model_path: str = "data/1998_nash.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SteadyStateHmt4f0Model = CellmlSteadyStateHmt
