...
**Source**: [physiome](https://models.physiomeproject.org/workspace/leloup_goldbeter_2004)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-leloup-goldbeter-2004-leloupgoldbeter2004-model
    alias: model
```
