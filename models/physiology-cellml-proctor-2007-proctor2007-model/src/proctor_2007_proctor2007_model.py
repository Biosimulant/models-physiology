...
"""Auto-generated CellML BioModule wrapper for Proctor, 2007.

Source: physiome:proctor_2007
Original: https://models.physiomeproject.org/workspace/proctor_2007
"""
...
class CellmlProctor2007(biosim.BioModule):
    """BioModule wrapper for CellML model: Proctor, 2007."""

    def __init__(self, model_path: str = "data/proctor_tsirigotis_gray_2007.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2007Proctor2007Model = CellmlProctor2007
