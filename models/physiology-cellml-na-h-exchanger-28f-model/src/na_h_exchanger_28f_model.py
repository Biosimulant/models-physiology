...
"""Auto-generated CellML BioModule wrapper for Na+/H+ Exchanger.

Source: physiome:28f
Original: https://models.physiomeproject.org/workspace/28f
"""
...
class CellmlNaHExchanger(biosim.BioModule):
    """BioModule wrapper for CellML model: Na+/H+ Exchanger."""

    def __init__(self, model_path: str = "data/Weinstein_1995_NHE3.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NaHExchanger28fModel = CellmlNaHExchanger
