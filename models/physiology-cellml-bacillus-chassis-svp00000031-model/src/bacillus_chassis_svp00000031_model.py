...
"""Auto-generated CellML BioModule wrapper for Bacillus Chassis.

Source: physiome:SVP_00000031
Original: https://models.physiomeproject.org/workspace/SVP_00000031
"""
...
class CellmlBacillusChassis(biosim.BioModule):
    """BioModule wrapper for CellML model: Bacillus Chassis."""

    def __init__(self, model_path: str = "data/Chassis_Bacillus.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BacillusChassisSvp00000031Model = CellmlBacillusChassis
