...
"""Auto-generated CellML BioModule wrapper for multi_FCU_AP_and_EC.

Source: physiome:8a9
Original: https://models.physiomeproject.org/workspace/8a9
"""
...
class CellmlMultiFcuApAndEc(biosim.BioModule):
    """BioModule wrapper for CellML model: multi_FCU_AP_and_EC."""

    def __init__(self, model_path: str = "data/FCU_AP_and_FCU_EC.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MultiFcuApAndEc8a9Model = CellmlMultiFcuApAndEc
