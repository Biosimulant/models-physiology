...
"""Auto-generated CellML BioModule wrapper for Fall, Keizer, 2001.

Source: physiome:fall_keizer_2001
Original: https://models.physiomeproject.org/workspace/fall_keizer_2001
"""
...
class CellmlFallKeizer20012(biosim.BioModule):
    """BioModule wrapper for CellML model: Fall, Keizer, 2001."""

    def __init__(self, model_path: str = "data/fall_keizer_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FallKeizer2001Fallkeizer2001Model = CellmlFallKeizer20012
