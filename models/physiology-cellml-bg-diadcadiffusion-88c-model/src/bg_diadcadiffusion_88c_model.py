...
"""Auto-generated CellML BioModule wrapper for BG_diadCaDiffusion.

Source: physiome:88c
Original: https://models.physiomeproject.org/workspace/88c
"""
...
class CellmlBgDiadcadiffusion(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_diadCaDiffusion."""

    def __init__(self, model_path: str = "data/BG_diadCaDiffusion.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgDiadcadiffusion88cModel = CellmlBgDiadcadiffusion
