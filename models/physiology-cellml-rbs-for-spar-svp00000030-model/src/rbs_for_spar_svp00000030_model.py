...
"""Auto-generated CellML BioModule wrapper for RBS for spaR.

Source: physiome:SVP_00000030
Original: https://models.physiomeproject.org/workspace/SVP_00000030
"""
...
class CellmlRbsForSpar(biosim.BioModule):
    """BioModule wrapper for CellML model: RBS for spaR."""

    def __init__(self, model_path: str = "data/Bugbuster_RBS_spaR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RbsForSparSvp00000030Model = CellmlRbsForSpar
