...
"""Auto-generated CellML BioModule wrapper for Bartolucci_Passini_Severi_2020.

Source: physiome:5fd
Original: https://models.physiomeproject.org/workspace/5fd
"""
...
class CellmlBartolucciPassiniSeveri2020(biosim.BioModule):
    """BioModule wrapper for CellML model: Bartolucci_Passini_Severi_2020."""

    def __init__(self, model_path: str = "data/BPS2020.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BartolucciPassiniSeveri20205fdModel = CellmlBartolucciPassiniSeveri2020
