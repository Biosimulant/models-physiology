...
"""Auto-generated CellML BioModule wrapper for Luo, Rudy, 1994.

Source: physiome:luo_rudy_1994
Original: https://models.physiomeproject.org/workspace/luo_rudy_1994
"""
...
class CellmlLuoRudy1994(biosim.BioModule):
    """BioModule wrapper for CellML model: Luo, Rudy, 1994."""

    def __init__(self, model_path: str = "data/luo_rudy_1994.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LuoRudy1994Luorudy1994Model = CellmlLuoRudy1994
