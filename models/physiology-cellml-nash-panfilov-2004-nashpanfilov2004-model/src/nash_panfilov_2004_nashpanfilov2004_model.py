...
"""Auto-generated CellML BioModule wrapper for Nash, Panfilov, 2004.

Source: physiome:nash_panfilov_2004
Original: https://models.physiomeproject.org/workspace/nash_panfilov_2004
"""
...
class CellmlNashPanfilov2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Nash, Panfilov, 2004."""

    def __init__(self, model_path: str = "data/nash_panfilov_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NashPanfilov2004Nashpanfilov2004Model = CellmlNashPanfilov2004
