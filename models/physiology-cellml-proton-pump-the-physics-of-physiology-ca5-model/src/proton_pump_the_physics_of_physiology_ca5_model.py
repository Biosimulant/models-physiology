...
"""Auto-generated CellML BioModule wrapper for Proton pump - The Physics of Physiology.

Source: physiome:ca5
Original: https://models.physiomeproject.org/workspace/ca5
"""
...
class CellmlProtonPumpThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: Proton pump - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/BG_H_pump.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ProtonPumpThePhysicsOfPhysiologyCa5Model = CellmlProtonPumpThePhysicsOfPhysiology
