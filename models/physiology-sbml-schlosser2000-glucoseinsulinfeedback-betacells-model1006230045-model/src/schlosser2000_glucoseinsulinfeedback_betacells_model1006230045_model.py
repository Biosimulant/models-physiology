...
"""Auto-generated SBML BioModule wrapper for Schlosser2000_GlucoseInsulinFeedback_BetaCells.

Source: biomodels_ebi:MODEL1006230045
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230045
"""
...
class SbmlSchlosser2000GlucoseinsulinfeedbackBetacells(biosim.BioModule):
    """BioModule wrapper for SBML model: Schlosser2000_GlucoseInsulinFeedback_BetaCells."""

    def __init__(self, model_path: str = "data/MODEL1006230045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schlosser2000GlucoseinsulinfeedbackBetacellsModel1006230045Model = SbmlSchlosser2000GlucoseinsulinfeedbackBetacells
