...
"""Auto-generated CellML BioModule wrapper for H+-ATPase (proton pump).

Source: physiome:293
Original: https://models.physiomeproject.org/workspace/293
"""
...
class CellmlHAtpaseProtonPump(biosim.BioModule):
    """BioModule wrapper for CellML model: H+-ATPase (proton pump)."""

    def __init__(self, model_path: str = "data/HATPase_test.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HAtpaseProtonPump293Model = CellmlHAtpaseProtonPump
