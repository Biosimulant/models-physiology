...
"""Auto-generated CellML BioModule wrapper for Wilkins, Sneyd, 1998.

Source: physiome:wilkins_sneyd_1998
Original: https://models.physiomeproject.org/workspace/wilkins_sneyd_1998
"""
...
class CellmlWilkinsSneyd1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Wilkins, Sneyd, 1998."""

    def __init__(self, model_path: str = "data/wilkins_sneyd_1998.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WilkinsSneyd1998Wilkinssneyd1998Model = CellmlWilkinsSneyd1998
