...
**Source**: [physiome](https://models.physiomeproject.org/workspace/liu_hu_peng_liu_1999)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-liu-hu-peng-liu-1999-liuhupengliu1999-model
    alias: model
```
