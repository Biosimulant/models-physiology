...
"""Auto-generated CellML BioModule wrapper for KTO knowledge page.

Source: physiome:bd1
Original: https://models.physiomeproject.org/workspace/bd1
"""
...
class CellmlKtoKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: KTO knowledge page."""

    def __init__(self, model_path: str = "data/BG_Kto.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KtoKnowledgePageBd1Model = CellmlKtoKnowledgePage
