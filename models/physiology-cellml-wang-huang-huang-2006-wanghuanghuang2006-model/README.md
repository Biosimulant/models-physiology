...
**Source**: [physiome](https://models.physiomeproject.org/workspace/wang_huang_huang_2006)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-wang-huang-huang-2006-wanghuanghuang2006-model
    alias: model
```
