...
**Source**: [physiome](https://models.physiomeproject.org/workspace/gross_and_hopfer_1998)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-gross-and-hopfer-1998-grossandhopfer1998-model
    alias: model
```
