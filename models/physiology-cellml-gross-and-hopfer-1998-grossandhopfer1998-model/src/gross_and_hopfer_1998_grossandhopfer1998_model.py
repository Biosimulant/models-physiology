...
"""Auto-generated CellML BioModule wrapper for Gross and Hopfer, 1998.

Source: physiome:gross_and_hopfer_1998
Original: https://models.physiomeproject.org/workspace/gross_and_hopfer_1998
"""
...
class CellmlGrossAndHopfer1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Gross and Hopfer, 1998."""

    def __init__(self, model_path: str = "data/gross_and_hopfer_1998.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GrossAndHopfer1998Grossandhopfer1998Model = CellmlGrossAndHopfer1998
