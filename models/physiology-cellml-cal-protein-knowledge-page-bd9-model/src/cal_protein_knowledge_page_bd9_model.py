...
"""Auto-generated CellML BioModule wrapper for CaL protein knowledge page.

Source: physiome:bd9
Original: https://models.physiomeproject.org/workspace/bd9
"""
...
class CellmlCalProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: CaL protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_CaL.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CalProteinKnowledgePageBd9Model = CellmlCalProteinKnowledgePage
