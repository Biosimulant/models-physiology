...
"""Auto-generated CellML BioModule wrapper for Keener, 2001.

Source: physiome:keener_2001
Original: https://models.physiomeproject.org/workspace/keener_2001
"""
...
class CellmlKeener2001(biosim.BioModule):
    """BioModule wrapper for CellML model: Keener, 2001."""

    def __init__(self, model_path: str = "data/keener_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Keener2001Keener2001Model = CellmlKeener2001
