...
"""Auto-generated CellML BioModule wrapper for Bond Graph CellML 2.0 models.

Source: physiome:afe
Original: https://models.physiomeproject.org/workspace/afe
"""
...
class CellmlBondGraphCellml20Models(biosim.BioModule):
    """BioModule wrapper for CellML model: Bond Graph CellML 2.0 models."""

    def __init__(self, model_path: str = "data/test_1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BondGraphCellml20ModelsAfeModel = CellmlBondGraphCellml20Models
