...
**Source**: [physiome](https://models.physiomeproject.org/workspace/1b5)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-cell-viability-models-for-tissue-exposed-to-ther-1b5-model
    alias: model
```
