...
**Source**: [physiome](https://models.physiomeproject.org/workspace/5b7)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-a-mathematical-model-of-the-outer-medullary-coll-5b7-model
    alias: model
```
