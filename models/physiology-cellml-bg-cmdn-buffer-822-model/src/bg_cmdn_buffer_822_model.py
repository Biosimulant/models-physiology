...
"""Auto-generated CellML BioModule wrapper for BG_CMDN_buffer.

Source: physiome:822
Original: https://models.physiomeproject.org/workspace/822
"""
...
class CellmlBgCmdnBuffer(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_CMDN_buffer."""

    def __init__(self, model_path: str = "data/BG_CMDN_buffer.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgCmdnBuffer822Model = CellmlBgCmdnBuffer
