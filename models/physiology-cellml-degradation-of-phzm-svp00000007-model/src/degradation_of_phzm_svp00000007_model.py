...
"""Auto-generated CellML BioModule wrapper for Degradation of PhzM.

Source: physiome:SVP_00000007
Original: https://models.physiomeproject.org/workspace/SVP_00000007
"""
...
class CellmlDegradationOfPhzm(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of PhzM."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_PhzM.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfPhzmSvp00000007Model = CellmlDegradationOfPhzm
