...
"""Auto-generated SBML BioModule wrapper for Shrestha2010_HypoCalcemia_PTHresponse.

Source: biomodels_ebi:BIOMD0000000276
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000276
"""
...
class SbmlShrestha2010HypocalcemiaPthresponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Shrestha2010_HypoCalcemia_PTHresponse."""

    def __init__(self, model_path: str = "data/BIOMD0000000276.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shrestha2010HypocalcemiaPthresponseBiomd0000000276Model = SbmlShrestha2010HypocalcemiaPthresponse
