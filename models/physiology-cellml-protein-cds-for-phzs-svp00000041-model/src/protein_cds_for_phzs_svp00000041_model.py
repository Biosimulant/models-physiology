...
"""Auto-generated CellML BioModule wrapper for Protein CDS for PhzS.

Source: physiome:SVP_00000041
Original: https://models.physiomeproject.org/workspace/SVP_00000041
"""
...
class CellmlProteinCdsForPhzs(biosim.BioModule):
    """BioModule wrapper for CellML model: Protein CDS for PhzS."""

    def __init__(self, model_path: str = "data/ElectrEcoBluDevice2_ProteinCDS_PhzS.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ProteinCdsForPhzsSvp00000041Model = CellmlProteinCdsForPhzs
