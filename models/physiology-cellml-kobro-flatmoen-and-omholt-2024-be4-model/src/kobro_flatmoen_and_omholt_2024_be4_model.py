...
"""Auto-generated CellML BioModule wrapper for Kobro-Flatmoen & Omholt 2024.

Source: physiome:be4
Original: https://models.physiomeproject.org/workspace/be4
"""
...
class CellmlKobroFlatmoenOmholt2024(biosim.BioModule):
    """BioModule wrapper for CellML model: Kobro-Flatmoen & Omholt 2024."""

    def __init__(self, model_path: str = "data/fig6.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KobroFlatmoenAndOmholt2024Be4Model = CellmlKobroFlatmoenOmholt2024
