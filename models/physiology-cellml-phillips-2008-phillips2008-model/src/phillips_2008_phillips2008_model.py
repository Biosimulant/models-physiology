...
"""Auto-generated CellML BioModule wrapper for Phillips 2008.

Source: physiome:phillips_2008
Original: https://models.physiomeproject.org/workspace/phillips_2008
"""
...
class CellmlPhillips20082(biosim.BioModule):
    """BioModule wrapper for CellML model: Phillips 2008."""

    def __init__(self, model_path: str = "data/phillips_baseline_2008.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Phillips2008Phillips2008Model = CellmlPhillips20082
