...
**Source**: [physiome](https://models.physiomeproject.org/workspace/ciliberto_tyson_2000)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-ciliberto-tyson-2000-cilibertotyson2000-model
    alias: model
```
