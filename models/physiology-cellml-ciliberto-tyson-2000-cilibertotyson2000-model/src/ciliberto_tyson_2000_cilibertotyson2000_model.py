...
"""Auto-generated CellML BioModule wrapper for Ciliberto, Tyson, 2000.

Source: physiome:ciliberto_tyson_2000
Original: https://models.physiomeproject.org/workspace/ciliberto_tyson_2000
"""
...
class CellmlCilibertoTyson2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Ciliberto, Tyson, 2000."""

    def __init__(self, model_path: str = "data/ciliberto_tyson_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CilibertoTyson2000Cilibertotyson2000Model = CellmlCilibertoTyson2000
