...
"""Auto-generated SBML BioModule wrapper for DallaMan2007_MealModel_GlucoseInsulinSystem.

Source: biomodels_ebi:BIOMD0000000379
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000379
"""
...
class SbmlDallaman2007MealmodelGlucoseinsulinsystem(biosim.BioModule):
    """BioModule wrapper for SBML model: DallaMan2007_MealModel_GlucoseInsulinSystem."""

    def __init__(self, model_path: str = "data/BIOMD0000000379.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dallaman2007MealmodelGlucoseinsulinsystemBiomd0000000379Model = SbmlDallaman2007MealmodelGlucoseinsulinsystem
