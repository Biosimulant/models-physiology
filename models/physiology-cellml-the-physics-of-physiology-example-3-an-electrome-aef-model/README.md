...
**Source**: [physiome](https://models.physiomeproject.org/workspace/aef)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-the-physics-of-physiology-example-3-an-electrome-aef-model/model.yaml
```
