...
"""Auto-generated CellML BioModule wrapper for BG_RTK.

Source: physiome:b2d
Original: https://models.physiomeproject.org/workspace/b2d
"""
...
class CellmlBgRtk(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_RTK."""

    def __init__(self, model_path: str = "data/BG_RTK.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
