...
"""Auto-generated CellML BioModule wrapper for BG_Ks.

Source: physiome:82d
Original: https://models.physiomeproject.org/workspace/82d
"""
...
class CellmlBgKs(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_Ks."""

    def __init__(self, model_path: str = "data/BG_Ks.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
