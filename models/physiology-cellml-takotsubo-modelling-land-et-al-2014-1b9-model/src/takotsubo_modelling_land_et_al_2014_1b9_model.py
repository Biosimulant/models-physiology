...
"""Auto-generated CellML BioModule wrapper for Takotsubo modelling, Land et al. 2014.

Source: physiome:1b9
Original: https://models.physiomeproject.org/workspace/1b9
"""
...
class CellmlTakotsuboModellingLandEtAl2014(biosim.BioModule):
    """BioModule wrapper for CellML model: Takotsubo modelling, Land et al. 2014."""

    def __init__(self, model_path: str = "data/Land_et_al_2012_v2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TakotsuboModellingLandEtAl20141b9Model = CellmlTakotsuboModellingLandEtAl2014
