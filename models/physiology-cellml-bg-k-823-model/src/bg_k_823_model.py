...
"""Auto-generated CellML BioModule wrapper for BG_K.

Source: physiome:823
Original: https://models.physiomeproject.org/workspace/823
"""
...
class CellmlBgK(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_K."""

    def __init__(self, model_path: str = "data/BG_K.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
