...
"""Auto-generated CellML BioModule wrapper for Blood volume control model.

Source: physiome:c99
Original: https://models.physiomeproject.org/workspace/c99
"""
...
class CellmlBloodVolumeControlModel(biosim.BioModule):
    """BioModule wrapper for CellML model: Blood volume control model."""

    def __init__(self, model_path: str = "data/BloodVolumeControl.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BloodVolumeControlModelC99Model = CellmlBloodVolumeControlModel
