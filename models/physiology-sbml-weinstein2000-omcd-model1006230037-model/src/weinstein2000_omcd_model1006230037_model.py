...
"""Auto-generated SBML BioModule wrapper for Weinstein2000_OMCD.

Source: biomodels_ebi:MODEL1006230037
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230037
"""
...
class SbmlWeinstein2000Omcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Weinstein2000_OMCD."""

    def __init__(self, model_path: str = "data/MODEL1006230037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Weinstein2000OmcdModel1006230037Model = SbmlWeinstein2000Omcd
