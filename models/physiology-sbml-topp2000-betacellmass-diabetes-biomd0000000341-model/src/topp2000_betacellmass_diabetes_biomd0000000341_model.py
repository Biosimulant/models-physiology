...
"""Auto-generated SBML BioModule wrapper for Topp2000_BetaCellMass_Diabetes.

Source: biomodels_ebi:BIOMD0000000341
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000341
"""
...
class SbmlTopp2000BetacellmassDiabetes(biosim.BioModule):
    """BioModule wrapper for SBML model: Topp2000_BetaCellMass_Diabetes."""

    def __init__(self, model_path: str = "data/BIOMD0000000341.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Topp2000BetacellmassDiabetesBiomd0000000341Model = SbmlTopp2000BetacellmassDiabetes
