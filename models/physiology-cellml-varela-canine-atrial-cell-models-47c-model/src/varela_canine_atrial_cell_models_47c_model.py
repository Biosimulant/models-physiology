...
"""Auto-generated CellML BioModule wrapper for Varela - Canine Atrial Cell Models.

Source: physiome:47c
Original: https://models.physiomeproject.org/workspace/47c
"""
...
class CellmlVarelaCanineAtrialCellModels(biosim.BioModule):
    """BioModule wrapper for CellML model: Varela - Canine Atrial Cell Models."""

    def __init__(self, model_path: str = "data/Varela_LA_2016.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
VarelaCanineAtrialCellModels47cModel = CellmlVarelaCanineAtrialCellModels
