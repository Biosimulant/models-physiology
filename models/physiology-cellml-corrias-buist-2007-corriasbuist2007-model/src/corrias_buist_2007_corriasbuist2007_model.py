...
"""Auto-generated CellML BioModule wrapper for Corrias, Buist, 2007.

Source: physiome:corrias_buist_2007
Original: https://models.physiomeproject.org/workspace/corrias_buist_2007
"""
...
class CellmlCorriasBuist2007(biosim.BioModule):
    """BioModule wrapper for CellML model: Corrias, Buist, 2007."""

    def __init__(self, model_path: str = "data/corrias_buist_2007.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CorriasBuist2007Corriasbuist2007Model = CellmlCorriasBuist2007
