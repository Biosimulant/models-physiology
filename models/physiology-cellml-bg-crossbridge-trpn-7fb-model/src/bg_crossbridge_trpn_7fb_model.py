...
"""Auto-generated CellML BioModule wrapper for BG_crossbridge_TRPN.

Source: physiome:7fb
Original: https://models.physiomeproject.org/workspace/7fb
"""
...
class CellmlBgCrossbridgeTrpn(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_crossbridge_TRPN."""

    def __init__(self, model_path: str = "data/BG_crossbridge_TRPN.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgCrossbridgeTrpn7fbModel = CellmlBgCrossbridgeTrpn
