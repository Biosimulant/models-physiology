...
"""Auto-generated CellML BioModule wrapper for Luo, Rudy, 1991.

Source: physiome:luo_rudy_1991
Original: https://models.physiomeproject.org/workspace/luo_rudy_1991
"""
...
class CellmlLuoRudy1991(biosim.BioModule):
    """BioModule wrapper for CellML model: Luo, Rudy, 1991."""

    def __init__(self, model_path: str = "data/luo_rudy_1991.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LuoRudy1991Luorudy1991Model = CellmlLuoRudy1991
