...
"""Auto-generated CellML BioModule wrapper for Wodarz, Jansen, 2003.

Source: physiome:wodarz_jansen_2003
Original: https://models.physiomeproject.org/workspace/wodarz_jansen_2003
"""
...
class CellmlWodarzJansen2003(biosim.BioModule):
    """BioModule wrapper for CellML model: Wodarz, Jansen, 2003."""

    def __init__(self, model_path: str = "data/wodarz_jansen_2003.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WodarzJansen2003Wodarzjansen2003Model = CellmlWodarzJansen2003
