...
"""Auto-generated SBML BioModule wrapper for Rattanakul2003_BoneFormation_PTHadministration.

Source: biomodels_ebi:MODEL1012140000
Original: https://www.ebi.ac.uk/biomodels/MODEL1012140000
"""
...
class SbmlRattanakul2003BoneformationPthadministration(biosim.BioModule):
    """BioModule wrapper for SBML model: Rattanakul2003_BoneFormation_PTHadministration."""

    def __init__(self, model_path: str = "data/MODEL1012140000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rattanakul2003BoneformationPthadministrationModel1012140000Model = SbmlRattanakul2003BoneformationPthadministration
