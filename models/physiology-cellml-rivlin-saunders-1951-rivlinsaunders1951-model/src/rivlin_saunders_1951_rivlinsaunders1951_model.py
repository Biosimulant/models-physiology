...
"""Auto-generated CellML BioModule wrapper for Rivlin, Saunders, 1951.

Source: physiome:rivlin_saunders_1951
Original: https://models.physiomeproject.org/workspace/rivlin_saunders_1951
"""
...
class CellmlRivlinSaunders1951(biosim.BioModule):
    """BioModule wrapper for CellML model: Rivlin, Saunders, 1951."""

    def __init__(self, model_path: str = "data/rivlin_saunders_1951.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RivlinSaunders1951Rivlinsaunders1951Model = CellmlRivlinSaunders1951
