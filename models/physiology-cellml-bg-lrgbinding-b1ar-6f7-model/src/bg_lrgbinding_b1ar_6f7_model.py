...
"""Auto-generated CellML BioModule wrapper for BG_LRGbinding_B1AR.

Source: physiome:6f7
Original: https://models.physiomeproject.org/workspace/6f7
"""
...
class CellmlBgLrgbindingB1ar(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_LRGbinding_B1AR."""

    def __init__(self, model_path: str = "data/BG_LRGbinding_B1AR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgLrgbindingB1ar6f7Model = CellmlBgLrgbindingB1ar
