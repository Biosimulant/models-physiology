...
**Source**: [physiome](https://models.physiomeproject.org/workspace/b80)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-potassium-delayed-rectifier-channel-knowledge-pa-b80-model/model.yaml
```
