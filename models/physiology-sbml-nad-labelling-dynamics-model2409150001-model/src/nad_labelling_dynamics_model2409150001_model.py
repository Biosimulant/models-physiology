...
"""Auto-generated SBML BioModule wrapper for NAD labelling dynamics.

Source: biomodels_ebi:MODEL2409150001
Original: https://www.ebi.ac.uk/biomodels/MODEL2409150001
"""
...
class SbmlNadLabellingDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: NAD labelling dynamics."""

    def __init__(self, model_path: str = "data/MODEL2409150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NadLabellingDynamicsModel2409150001Model = SbmlNadLabellingDynamics
