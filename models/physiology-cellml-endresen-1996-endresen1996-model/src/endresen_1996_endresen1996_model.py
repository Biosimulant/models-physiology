...
"""Auto-generated CellML BioModule wrapper for Endresen, 1996.

Source: physiome:endresen_1996
Original: https://models.physiomeproject.org/workspace/endresen_1996
"""
...
class CellmlEndresen1996(biosim.BioModule):
    """BioModule wrapper for CellML model: Endresen, 1996."""

    def __init__(self, model_path: str = "data/endresen_1996.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Endresen1996Endresen1996Model = CellmlEndresen1996
