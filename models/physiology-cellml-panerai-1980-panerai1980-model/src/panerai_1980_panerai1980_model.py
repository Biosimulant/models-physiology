...
"""Auto-generated CellML BioModule wrapper for Panerai, 1980.

Source: physiome:panerai_1980
Original: https://models.physiomeproject.org/workspace/panerai_1980
"""
...
class CellmlPanerai1980(biosim.BioModule):
    """BioModule wrapper for CellML model: Panerai, 1980."""

    def __init__(self, model_path: str = "data/panerai_1980.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Panerai1980Panerai1980Model = CellmlPanerai1980
