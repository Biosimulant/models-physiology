...
"""Auto-generated CellML BioModule wrapper for TranSERCA.

Source: physiome:b0b
Original: https://models.physiomeproject.org/workspace/b0b
"""
...
class CellmlTranserca(biosim.BioModule):
    """BioModule wrapper for CellML model: TranSERCA."""

    def __init__(self, model_path: str = "data/TranSERCA.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TransercaB0bModel = CellmlTranserca
