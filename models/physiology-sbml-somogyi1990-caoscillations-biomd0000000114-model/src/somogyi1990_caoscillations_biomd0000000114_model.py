...
"""Auto-generated SBML BioModule wrapper for Somogyi1990_CaOscillations.

Source: biomodels_ebi:BIOMD0000000114
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000114
"""
...
class SbmlSomogyi1990Caoscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Somogyi1990_CaOscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000114.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Somogyi1990CaoscillationsBiomd0000000114Model = SbmlSomogyi1990Caoscillations
