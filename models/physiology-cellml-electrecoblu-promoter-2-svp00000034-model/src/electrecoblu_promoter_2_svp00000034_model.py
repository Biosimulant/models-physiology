...
"""Auto-generated CellML BioModule wrapper for ElectrEcoBlu Promoter 2.

Source: physiome:SVP_00000034
Original: https://models.physiomeproject.org/workspace/SVP_00000034
"""
...
class CellmlElectrecobluPromoter2(biosim.BioModule):
    """BioModule wrapper for CellML model: ElectrEcoBlu Promoter 2."""

    def __init__(self, model_path: str = "data/ElectrEcoBluDevice2_Promoter.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ElectrecobluPromoter2Svp00000034Model = CellmlElectrecobluPromoter2
