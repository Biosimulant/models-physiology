...
"""Auto-generated CellML BioModule wrapper for BG_AE1_Weinstein.

Source: physiome:877
Original: https://models.physiomeproject.org/workspace/877
"""
...
class CellmlBgAe1Weinstein(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_AE1_Weinstein."""

    def __init__(self, model_path: str = "data/BG_AE1_weinstein.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgAe1Weinstein877Model = CellmlBgAe1Weinstein
