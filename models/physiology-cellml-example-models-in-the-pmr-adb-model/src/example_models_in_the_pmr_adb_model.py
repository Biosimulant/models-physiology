...
"""Auto-generated CellML BioModule wrapper for Example Models in the PMR.

Source: physiome:adb
Original: https://models.physiomeproject.org/workspace/adb
"""
...
class CellmlExampleModelsInThePmr2(biosim.BioModule):
    """BioModule wrapper for CellML model: Example Models in the PMR."""

    def __init__(self, model_path: str = "data/exampleModelPMR_1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ExampleModelsInThePmrAdbModel = CellmlExampleModelsInThePmr2
