...
**Source**: [physiome](https://models.physiomeproject.org/workspace/aed)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-the-physics-of-physiology-example-1-an-electrica-aed-model/model.yaml
```
