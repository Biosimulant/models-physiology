...
"""Auto-generated CellML BioModule wrapper for BG_NCX.

Source: physiome:828
Original: https://models.physiomeproject.org/workspace/828
"""
...
class CellmlBgNcx(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_NCX."""

    def __init__(self, model_path: str = "data/BG_NCX.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
