...
"""Auto-generated CellML BioModule wrapper for Fenton, Karma, 1998.

Source: physiome:fenton_karma_1998
Original: https://models.physiomeproject.org/workspace/fenton_karma_1998
"""
...
class CellmlFentonKarma19982(biosim.BioModule):
    """BioModule wrapper for CellML model: Fenton, Karma, 1998."""

    def __init__(self, model_path: str = "data/fenton_karma_1998_BR.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FentonKarma1998Fentonkarma1998Model = CellmlFentonKarma19982
