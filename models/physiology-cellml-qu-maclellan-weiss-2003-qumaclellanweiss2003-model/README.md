...
**Source**: [physiome](https://models.physiomeproject.org/workspace/qu_maclellan_weiss_2003)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-qu-maclellan-weiss-2003-qumaclellanweiss2003-model
    alias: model
```
