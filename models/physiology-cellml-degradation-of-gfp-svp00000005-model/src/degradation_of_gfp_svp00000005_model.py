...
"""Auto-generated CellML BioModule wrapper for Degradation of GFP.

Source: physiome:SVP_00000005
Original: https://models.physiomeproject.org/workspace/SVP_00000005
"""
...
class CellmlDegradationOfGfp(biosim.BioModule):
    """BioModule wrapper for CellML model: Degradation of GFP."""

    def __init__(self, model_path: str = "data/Bioenvironment_Degradation_GFP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DegradationOfGfpSvp00000005Model = CellmlDegradationOfGfp
