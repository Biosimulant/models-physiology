...
"""Auto-generated CellML BioModule wrapper for Na+/K+-ATPase (sodium-potassium pump).

Source: physiome:294
Original: https://models.physiomeproject.org/workspace/294
"""
...
class CellmlNaKAtpaseSodiumPotassiumPump(biosim.BioModule):
    """BioModule wrapper for CellML model: Na+/K+-ATPase (sodium-potassium pump)."""

    def __init__(self, model_path: str = "data/NaK_test.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NaKAtpaseSodiumPotassiumPump294Model = CellmlNaKAtpaseSodiumPotassiumPump
