...
"""Auto-generated CellML BioModule wrapper for SED-ML example.

Source: physiome:4c6
Original: https://models.physiomeproject.org/workspace/4c6
"""
...
class CellmlSedMlExample(biosim.BioModule):
    """BioModule wrapper for CellML model: SED-ML example."""

    def __init__(self, model_path: str = "data/vanderpol.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SedMlExample4c6Model = CellmlSedMlExample
