...
"""Auto-generated SBML BioModule wrapper for O'Donovan2022 - the Mixed Meal Model.

Source: biomodels_ebi:MODEL2212300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2212300001
"""
...
class SbmlODonovan2022TheMixedMealModel(biosim.BioModule):
    """BioModule wrapper for SBML model: O'Donovan2022 - the Mixed Meal Model."""

    def __init__(self, model_path: str = "data/MODEL2212300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ODonovan2022TheMixedMealModelModel2212300001Model = SbmlODonovan2022TheMixedMealModel
