...
"""Auto-generated SBML BioModule wrapper for Rattanakul2003_BoneFormationModel.

Source: biomodels_ebi:BIOMD0000000274
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000274
"""
...
class SbmlRattanakul2003Boneformationmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Rattanakul2003_BoneFormationModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000274.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rattanakul2003BoneformationmodelBiomd0000000274Model = SbmlRattanakul2003Boneformationmodel
