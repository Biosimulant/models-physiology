...
"""Auto-generated CellML BioModule wrapper for Shaw, Rudy, 1997.

Source: physiome:shaw_rudy_1997
Original: https://models.physiomeproject.org/workspace/shaw_rudy_1997
"""
...
class CellmlShawRudy1997(biosim.BioModule):
    """BioModule wrapper for CellML model: Shaw, Rudy, 1997."""

    def __init__(self, model_path: str = "data/shaw_rudy_1997.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ShawRudy1997Shawrudy1997Model = CellmlShawRudy1997
