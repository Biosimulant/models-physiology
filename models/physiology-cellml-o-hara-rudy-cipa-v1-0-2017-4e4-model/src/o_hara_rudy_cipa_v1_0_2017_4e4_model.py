...
"""Auto-generated CellML BioModule wrapper for O'Hara-Rudy-CiPA-v1.0 (2017).

Source: physiome:4e4
Original: https://models.physiomeproject.org/workspace/4e4
"""
...
class CellmlOHaraRudyCipaV102017(biosim.BioModule):
    """BioModule wrapper for CellML model: O'Hara-Rudy-CiPA-v1.0 (2017)."""

    def __init__(self, model_path: str = "data/ohara_rudy_cipa_v1_2017.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
OHaraRudyCipaV1020174e4Model = CellmlOHaraRudyCipaV102017
