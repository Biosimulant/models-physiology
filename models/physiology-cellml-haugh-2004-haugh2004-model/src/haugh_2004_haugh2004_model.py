...
"""Auto-generated CellML BioModule wrapper for Haugh, 2004.

Source: physiome:haugh_2004
Original: https://models.physiomeproject.org/workspace/haugh_2004
"""
...
class CellmlHaugh2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Haugh, 2004."""

    def __init__(self, model_path: str = "data/haugh_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haugh2004Haugh2004Model = CellmlHaugh2004
