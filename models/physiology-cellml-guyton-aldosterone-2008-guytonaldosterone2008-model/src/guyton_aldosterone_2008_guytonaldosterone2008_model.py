...
"""Auto-generated CellML BioModule wrapper for Guyton, Aldosterone, 2008.

Source: physiome:guyton_aldosterone_2008
Original: https://models.physiomeproject.org/workspace/guyton_aldosterone_2008
"""
...
class CellmlGuytonAldosterone2008(biosim.BioModule):
    """BioModule wrapper for CellML model: Guyton, Aldosterone, 2008."""

    def __init__(self, model_path: str = "data/aldosterone.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GuytonAldosterone2008Guytonaldosterone2008Model = CellmlGuytonAldosterone2008
