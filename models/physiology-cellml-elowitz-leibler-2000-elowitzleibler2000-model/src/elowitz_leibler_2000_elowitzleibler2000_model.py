...
"""Auto-generated CellML BioModule wrapper for Elowitz, Leibler, 2000.

Source: physiome:elowitz_leibler_2000
Original: https://models.physiomeproject.org/workspace/elowitz_leibler_2000
"""
...
class CellmlElowitzLeibler2000(biosim.BioModule):
    """BioModule wrapper for CellML model: Elowitz, Leibler, 2000."""

    def __init__(self, model_path: str = "data/elowitz_leibler_2000.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ElowitzLeibler2000Elowitzleibler2000Model = CellmlElowitzLeibler2000
