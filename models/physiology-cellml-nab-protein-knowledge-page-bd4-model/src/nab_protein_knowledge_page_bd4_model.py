...
"""Auto-generated CellML BioModule wrapper for NaB protein knowledge page.

Source: physiome:bd4
Original: https://models.physiomeproject.org/workspace/bd4
"""
...
class CellmlNabProteinKnowledgePage(biosim.BioModule):
    """BioModule wrapper for CellML model: NaB protein knowledge page."""

    def __init__(self, model_path: str = "data/BG_NaB.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NabProteinKnowledgePageBd4Model = CellmlNabProteinKnowledgePage
