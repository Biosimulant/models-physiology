...
"""Auto-generated CellML BioModule wrapper for BG Epithelial Transport.

Source: physiome:d5e
Original: https://models.physiomeproject.org/workspace/d5e
"""
...
class CellmlBgEpithelialTransport(biosim.BioModule):
    """BioModule wrapper for CellML model: BG Epithelial Transport."""

    def __init__(self, model_path: str = "data/Epithelial_cell_v1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgEpithelialTransportD5eModel = CellmlBgEpithelialTransport
