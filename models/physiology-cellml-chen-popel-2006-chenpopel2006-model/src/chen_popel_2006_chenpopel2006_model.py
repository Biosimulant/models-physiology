...
"""Auto-generated CellML BioModule wrapper for Chen, Popel, 2006.

Source: physiome:chen_popel_2006
Original: https://models.physiomeproject.org/workspace/chen_popel_2006
"""
...
class CellmlChenPopel20062(biosim.BioModule):
    """BioModule wrapper for CellML model: Chen, Popel, 2006."""

    def __init__(self, model_path: str = "data/chen_popel_2006.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChenPopel2006Chenpopel2006Model = CellmlChenPopel20062
