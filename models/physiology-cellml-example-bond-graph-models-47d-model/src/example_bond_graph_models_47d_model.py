...
"""Auto-generated CellML BioModule wrapper for Example bond graph models.

Source: physiome:47d
Original: https://models.physiomeproject.org/workspace/47d
"""
...
class CellmlExampleBondGraphModels(biosim.BioModule):
    """BioModule wrapper for CellML model: Example bond graph models."""

    def __init__(self, model_path: str = "data/BG_tutorial_model_electrical_1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ExampleBondGraphModels47dModel = CellmlExampleBondGraphModels
