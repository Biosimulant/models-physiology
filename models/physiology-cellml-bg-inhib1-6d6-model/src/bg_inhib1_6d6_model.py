...
"""Auto-generated CellML BioModule wrapper for BG_Inhib1.

Source: physiome:6d6
Original: https://models.physiomeproject.org/workspace/6d6
"""
...
class CellmlBgInhib1(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_Inhib1."""

    def __init__(self, model_path: str = "data/BG_Inhib1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BgInhib16d6Model = CellmlBgInhib1
