...
"""Auto-generated CellML BioModule wrapper for Tran 2010.

Source: physiome:tran_2009
Original: https://models.physiomeproject.org/workspace/tran_2009
"""
...
class CellmlTran2010(biosim.BioModule):
    """BioModule wrapper for CellML model: Tran 2010."""

    def __init__(self, model_path: str = "data/tran_2009.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tran2010Tran2009Model = CellmlTran2010
