...
"""Auto-generated CellML BioModule wrapper for Tong, Tribe, Smith, Taggart, 2014.

Source: physiome:262
Original: https://models.physiomeproject.org/workspace/262
"""
...
class CellmlTongTribeSmithTaggart2014(biosim.BioModule):
    """BioModule wrapper for CellML model: Tong, Tribe, Smith, Taggart, 2014."""

    def __init__(self, model_path: str = "data/Tong_Tribe_Smith_Taggart_2014.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TongTribeSmithTaggart2014262Model = CellmlTongTribeSmithTaggart2014
