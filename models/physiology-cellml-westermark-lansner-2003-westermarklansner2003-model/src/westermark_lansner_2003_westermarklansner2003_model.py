...
"""Auto-generated CellML BioModule wrapper for Westermark, Lansner, 2003.

Source: physiome:westermark_lansner_2003
Original: https://models.physiomeproject.org/workspace/westermark_lansner_2003
"""
...
class CellmlWestermarkLansner2003(biosim.BioModule):
    """BioModule wrapper for CellML model: Westermark, Lansner, 2003."""

    def __init__(self, model_path: str = "data/cons_law1.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
WestermarkLansner2003Westermarklansner2003Model = CellmlWestermarkLansner2003
