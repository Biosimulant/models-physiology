...
**Source**: [physiome](https://models.physiomeproject.org/workspace/703)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-computational-modeling-of-anoctamin-1-calcium-ac-703-model
    alias: model
```
