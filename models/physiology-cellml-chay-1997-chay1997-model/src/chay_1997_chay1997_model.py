...
"""Auto-generated CellML BioModule wrapper for Chay, 1997.

Source: physiome:chay_1997
Original: https://models.physiomeproject.org/workspace/chay_1997
"""
...
class CellmlChay1997(biosim.BioModule):
    """BioModule wrapper for CellML model: Chay, 1997."""

    def __init__(self, model_path: str = "data/chay_1997.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chay1997Chay1997Model = CellmlChay1997
