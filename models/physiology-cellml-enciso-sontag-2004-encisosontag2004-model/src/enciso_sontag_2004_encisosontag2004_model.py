...
"""Auto-generated CellML BioModule wrapper for Enciso, Sontag, 2004.

Source: physiome:enciso_sontag_2004
Original: https://models.physiomeproject.org/workspace/enciso_sontag_2004
"""
...
class CellmlEncisoSontag2004(biosim.BioModule):
    """BioModule wrapper for CellML model: Enciso, Sontag, 2004."""

    def __init__(self, model_path: str = "data/enciso_sontag_2004.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EncisoSontag2004Encisosontag2004Model = CellmlEncisoSontag2004
