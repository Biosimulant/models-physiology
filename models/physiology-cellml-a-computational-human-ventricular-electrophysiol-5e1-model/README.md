...
**Source**: [physiome](https://models.physiomeproject.org/workspace/5e1)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-a-computational-human-ventricular-electrophysiol-5e1-model/model.yaml
```
