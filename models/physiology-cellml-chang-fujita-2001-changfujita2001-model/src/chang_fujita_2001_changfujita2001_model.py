...
"""Auto-generated CellML BioModule wrapper for Chang, Fujita, 2001.

Source: physiome:chang_fujita_2001
Original: https://models.physiomeproject.org/workspace/chang_fujita_2001
"""
...
class CellmlChangFujita2001(biosim.BioModule):
    """BioModule wrapper for CellML model: Chang, Fujita, 2001."""

    def __init__(self, model_path: str = "data/chang_fujita_2001_H_ATPase.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChangFujita2001Changfujita2001Model = CellmlChangFujita2001
