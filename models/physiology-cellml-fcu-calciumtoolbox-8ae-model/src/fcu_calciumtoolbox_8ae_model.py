...
"""Auto-generated CellML BioModule wrapper for FCU_calciumToolbox.

Source: physiome:8ae
Original: https://models.physiomeproject.org/workspace/8ae
"""
...
class CellmlFcuCalciumtoolbox(biosim.BioModule):
    """BioModule wrapper for CellML model: FCU_calciumToolbox."""

    def __init__(self, model_path: str = "data/FCU_CaToolbox.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FcuCalciumtoolbox8aeModel = CellmlFcuCalciumtoolbox
