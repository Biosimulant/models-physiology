...
"""Auto-generated CellML BioModule wrapper for Depaor, Timmons, 1986.

Source: physiome:depaor_timmons_1986
Original: https://models.physiomeproject.org/workspace/depaor_timmons_1986
"""
...
class CellmlDepaorTimmons1986(biosim.BioModule):
    """BioModule wrapper for CellML model: Depaor, Timmons, 1986."""

    def __init__(self, model_path: str = "data/depaor_timmons_1986.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DepaorTimmons1986Depaortimmons1986Model = CellmlDepaorTimmons1986
