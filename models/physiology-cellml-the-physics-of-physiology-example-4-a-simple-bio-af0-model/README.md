...
**Source**: [physiome](https://models.physiomeproject.org/workspace/af0)
**Standard**: cellml
**Authors**: physiome
...
models:
  - path: ../../models/physiology-cellml-the-physics-of-physiology-example-4-a-simple-bio-af0-model
    alias: model
```
