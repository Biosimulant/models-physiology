...
"""Auto-generated CellML BioModule wrapper for GLUT2 - The Physics of Physiology.

Source: physiome:c6b
Original: https://models.physiomeproject.org/workspace/c6b
"""
...
class CellmlGlut2ThePhysicsOfPhysiology(biosim.BioModule):
    """BioModule wrapper for CellML model: GLUT2 - The Physics of Physiology."""

    def __init__(self, model_path: str = "data/GLUT2_BG.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Glut2ThePhysicsOfPhysiologyC6bModel = CellmlGlut2ThePhysicsOfPhysiology
