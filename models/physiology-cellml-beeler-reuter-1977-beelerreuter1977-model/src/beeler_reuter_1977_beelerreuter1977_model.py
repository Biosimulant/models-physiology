...
"""Auto-generated CellML BioModule wrapper for Beeler, Reuter, 1977.

Source: physiome:beeler_reuter_1977
Original: https://models.physiomeproject.org/workspace/beeler_reuter_1977
"""
...
class CellmlBeelerReuter1977(biosim.BioModule):
    """BioModule wrapper for CellML model: Beeler, Reuter, 1977."""

    def __init__(self, model_path: str = "data/beeler_reuter_1977.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BeelerReuter1977Beelerreuter1977Model = CellmlBeelerReuter1977
