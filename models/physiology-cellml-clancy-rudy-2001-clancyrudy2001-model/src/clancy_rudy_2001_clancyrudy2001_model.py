...
"""Auto-generated CellML BioModule wrapper for Clancy, Rudy, 2001.

Source: physiome:clancy_rudy_2001
Original: https://models.physiomeproject.org/workspace/clancy_rudy_2001
"""
...
class CellmlClancyRudy2001(biosim.BioModule):
    """BioModule wrapper for CellML model: Clancy, Rudy, 2001."""

    def __init__(self, model_path: str = "data/clancy_rudy_2001.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ClancyRudy2001Clancyrudy2001Model = CellmlClancyRudy2001
