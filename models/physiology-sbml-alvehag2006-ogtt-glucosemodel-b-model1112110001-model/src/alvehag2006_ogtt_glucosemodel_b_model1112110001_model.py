...
"""Auto-generated SBML BioModule wrapper for Alvehag2006_OGTT_GlucoseModel_B.

Source: biomodels_ebi:MODEL1112110001
Original: https://www.ebi.ac.uk/biomodels/MODEL1112110001
"""
...
class SbmlAlvehag2006OgttGlucosemodelB(biosim.BioModule):
    """BioModule wrapper for SBML model: Alvehag2006_OGTT_GlucoseModel_B."""

    def __init__(self, model_path: str = "data/MODEL1112110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alvehag2006OgttGlucosemodelBModel1112110001Model = SbmlAlvehag2006OgttGlucosemodelB
