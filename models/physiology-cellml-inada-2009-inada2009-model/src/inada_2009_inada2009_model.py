...
"""Auto-generated CellML BioModule wrapper for Inada 2009.

Source: physiome:inada_2009
Original: https://models.physiomeproject.org/workspace/inada_2009
"""
...
class CellmlInada2009(biosim.BioModule):
    """BioModule wrapper for CellML model: Inada 2009."""

    def __init__(self, model_path: str = "data/inada_AN_2009.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Inada2009Inada2009Model = CellmlInada2009
