...
"""Auto-generated CellML BioModule wrapper for Weinstein, 1998.

Source: physiome:weinstein_1998
Original: https://models.physiomeproject.org/workspace/weinstein_1998
"""
...
class CellmlWeinstein1998(biosim.BioModule):
    """BioModule wrapper for CellML model: Weinstein, 1998."""

    def __init__(self, model_path: str = "data/weinstein_1998_variant01.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Weinstein1998Weinstein1998Model = CellmlWeinstein1998
