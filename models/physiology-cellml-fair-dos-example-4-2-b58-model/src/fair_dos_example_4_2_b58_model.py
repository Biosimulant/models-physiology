...
"""Auto-generated CellML BioModule wrapper for FAIR DOs example 4.2.

Source: physiome:b58
Original: https://models.physiomeproject.org/workspace/b58
"""
...
class CellmlFairDosExample42(biosim.BioModule):
    """BioModule wrapper for CellML model: FAIR DOs example 4.2."""

    def __init__(self, model_path: str = "data/FAIRDO_BG_example_4.2.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FairDosExample42B58Model = CellmlFairDosExample42
