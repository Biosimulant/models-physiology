...
"""Auto-generated CellML BioModule wrapper for Difrancesco, Noble, 1985.

Source: physiome:difrancesco_noble_1985
Original: https://models.physiomeproject.org/workspace/difrancesco_noble_1985
"""
...
class CellmlDifrancescoNoble1985(biosim.BioModule):
    """BioModule wrapper for CellML model: Difrancesco, Noble, 1985."""

    def __init__(self, model_path: str = "data/difrancesco_noble_1985.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DifrancescoNoble1985Difrancesconoble1985Model = CellmlDifrancescoNoble1985
