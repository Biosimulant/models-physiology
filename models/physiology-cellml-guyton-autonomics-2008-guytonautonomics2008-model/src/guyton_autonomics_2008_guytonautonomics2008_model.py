...
"""Auto-generated CellML BioModule wrapper for Guyton, Autonomics, 2008.

Source: physiome:guyton_autonomics_2008
Original: https://models.physiomeproject.org/workspace/guyton_autonomics_2008
"""
...
class CellmlGuytonAutonomics2008(biosim.BioModule):
    """BioModule wrapper for CellML model: Guyton, Autonomics, 2008."""

    def __init__(self, model_path: str = "data/autonomics.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GuytonAutonomics2008Guytonautonomics2008Model = CellmlGuytonAutonomics2008
