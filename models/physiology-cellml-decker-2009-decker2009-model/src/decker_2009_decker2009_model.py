...
"""Auto-generated CellML BioModule wrapper for Decker 2009.

Source: physiome:decker_2009
Original: https://models.physiomeproject.org/workspace/decker_2009
"""
...
class CellmlDecker20092(biosim.BioModule):
    """BioModule wrapper for CellML model: Decker 2009."""

    def __init__(self, model_path: str = "data/decker_2009.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Decker2009Decker2009Model = CellmlDecker20092
