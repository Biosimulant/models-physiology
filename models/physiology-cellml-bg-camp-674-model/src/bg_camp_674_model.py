...
"""Auto-generated CellML BioModule wrapper for BG_cAMP.

Source: physiome:674
Original: https://models.physiomeproject.org/workspace/674
"""
...
class CellmlBgCamp(biosim.BioModule):
    """BioModule wrapper for CellML model: BG_cAMP."""

    def __init__(self, model_path: str = "data/BG_cAMP.cellml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
