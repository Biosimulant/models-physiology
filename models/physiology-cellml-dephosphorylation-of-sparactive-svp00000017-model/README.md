...
**Source**: [physiome](https://models.physiomeproject.org/workspace/SVP_00000017)
**Standard**: cellml
**Authors**: physiome
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/physiology-cellml-dephosphorylation-of-sparactive-svp00000017-model/model.yaml
```
