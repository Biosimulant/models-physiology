# COMBO_0077 - Physiology Cardiac Electrophysiology
...
- `physiology-cellml-atrial-fibroblast-model-4be-model`: Physiology: AtrialFibroblastModel4beModel
- `physiology-cellml-fcu-cardiac-ph-885-model`: Physiology: FcuCardiacPh885Model
...
## Source Provenance
- physiology-cellml-atrial-fibroblast-model-4be-model :: physiome:4be :: https://models.physiomeproject.org/workspace/4be
