#!/usr/bin/env python3
"""Run generated space: physiology-cardiac-electrophysiology-combo-0008."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'physiology-cardiac-electrophysiology-combo-0008')} duration={duration} tick_dt={tick_dt}")
