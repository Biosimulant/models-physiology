#!/usr/bin/env python3
"""Run generated space: physiology-cardiac-electrophysiology-combo-0012."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-physiology": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'physiology-cardiac-electrophysiology-combo-0012')} duration={duration} tick_dt={tick_dt}")
